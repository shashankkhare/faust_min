 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			float fTempFTZ0 = (fTemp1 - ((fSlow4 * fRec1[1]) + (fConst4 * fRec1[2])));
			fRec1[0] = ((std::fabs(fTempFTZ0) > 1.17549435e-38f) ? fTempFTZ0 : 0.0f);
			float fTempFTZ1 = (fTemp1 - ((fSlow5 * fRec2[1]) + (fConst8 * fRec2[2])));
			fRec2[0] = ((std::fabs(fTempFTZ1) > 1.17549435e-38f) ? fTempFTZ1 : 0.0f);
			float fTempFTZ2 = (fTemp1 - ((fSlow6 * fRec3[1]) + (fConst12 * fRec3[2])));
			fRec3[0] = ((std::fabs(fTempFTZ2) > 1.17549435e-38f) ? fTempFTZ2 : 0.0f);
			float fTempFTZ3 = (fTemp1 - ((fSlow7 * fRec4[1]) + (fConst16 * fRec4[2])));
			fRec4[0] = ((std::fabs(fTempFTZ3) > 1.17549435e-38f) ? fTempFTZ3 : 0.0f);
			float fTempFTZ4 = (fTemp1 - ((fSlow8 * fRec5[1]) + (fConst20 * fRec5[2])));
			fRec5[0] = ((std::fabs(fTempFTZ4) > 1.17549435e-38f) ? fTempFTZ4 : 0.0f);
			float fTempFTZ5 = (fTemp1 - ((fSlow9 * fRec6[1]) + (fConst24 * fRec6[2])));
			fRec6[0] = ((std::fabs(fTempFTZ5) > 1.17549435e-38f) ? fTempFTZ5 : 0.0f);
			float fTempFTZ6 = (fTemp1 - ((fSlow10 * fRec7[1]) + (fConst28 * fRec7[2])));
			...
			fVec1[0] = fTemp2;
			float fTempFTZ7 = ((0.995000005f * fRec0[1]) + (0.142857149f * (fTemp2 - fVec1[1])));
