 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			float fTempFTZ2 = (fRec2[0] - (fSlow19 * ((fSlow20 * fRec3[2]) + (fSlow21 * fRec3[1]))));
			fRec3[0] = ((std::fabs(fTempFTZ2) > 1.17549435e-38f) ? fTempFTZ2 : 0.0f);
			float fTempFTZ3 = (fRec2[0] - (fSlow28 * ((fSlow29 * fRec4[2]) + (fSlow30 * fRec4[1]))));
			fRec4[0] = ((std::fabs(fTempFTZ3) > 1.17549435e-38f) ? fTempFTZ3 : 0.0f);
			float fTempFTZ4 = (fRec2[0] - (fSlow37 * ((fSlow38 * fRec5[2]) + (fSlow39 * fRec5[1]))));
			fRec5[0] = ((std::fabs(fTempFTZ4) > 1.17549435e-38f) ? fTempFTZ4 : 0.0f);
			float fTempFTZ5 = (fRec2[0] - (fSlow46 * ((fSlow47 * fRec6[2]) + (fSlow48 * fRec6[1]))));
			fRec6[0] = ((std::fabs(fTempFTZ5) > 1.17549435e-38f) ? fTempFTZ5 : 0.0f);
			float fTempFTZ6 = (fRec2[0] - (fSlow55 * ((fSlow56 * fRec7[2]) + (fSlow57 * fRec7[1]))));
			fRec7[0] = ((std::fabs(fTempFTZ6) > 1.17549435e-38f) ? fTempFTZ6 : 0.0f);
			float fTempFTZ7 = (fRec2[0] - (fSlow63 * ((fSlow64 * fRec8[2]) + (fSlow65 * fRec8[1]))));
