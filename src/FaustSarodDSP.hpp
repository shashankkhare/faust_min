...
class FaustSarodDSP : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst138 = (1.0f / fConst136);
		fConst139 = (((fConst135 + -0.25f) / fConst134) + 1.0f);
		fConst140 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst134))));
		float fConst141 = std::tan((1683.57947f / fConst0));
		float fConst142 = (1.0f / fConst141);
		float fConst143 = (((fConst142 + 0.25f) / fConst141) + 1.0f);
		float fConst144 = (fConst141 * fConst143);
		fConst145 = (1.0f / fConst144);
		fConst146 = (1.0f / fConst143);
		fConst147 = (((fConst142 + -0.25f) / fConst141) + 1.0f);
		fConst148 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst141))));
		float fConst149 = std::tan((1709.65466f / fConst0));
		float fConst150 = (1.0f / fConst149);
		float fConst151 = (((fConst150 + 0.25f) / fConst149) + 1.0f);
		float fConst152 = (fConst149 * fConst151);
		fConst153 = (1.0f / fConst152);
		fConst154 = (1.0f / fConst151);
		fConst155 = (((fConst150 + -0.25f) / fConst149) + 1.0f);
		fConst156 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst149))));
		fConst157 = (0.0f - (0.150000006f / fConst152));
		float fConst158 = std::tan((1565.76978f / fConst0));
		...
		float fConst166 = std::tan((1642.73877f / fConst0));
		float fConst167 = (1.0f / fConst166);
		float fConst168 = (((fConst167 + 0.25f) / fConst166) + 1.0f);
		float fConst169 = (fConst166 * fConst168);
		fConst170 = (1.0f / fConst169);
		fConst171 = (1.0f / fConst168);
		fConst172 = (((fConst167 + -0.25f) / fConst166) + 1.0f);
		fConst173 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst166))));
		fConst174 = (0.0f - (0.200000003f / fConst169));
		float fConst175 = std::tan((743.61499f / fConst0));
		...
		float fConst183 = std::tan((754.610535f / fConst0));
		float fConst184 = (1.0f / fConst183);
		float fConst185 = (((fConst184 + 0.25f) / fConst183) + 1.0f);
		float fConst186 = (fConst183 * fConst185);
		fConst187 = (1.0f / fConst186);
		fConst188 = (1.0f / fConst185);
		fConst189 = (((fConst184 + -0.25f) / fConst183) + 1.0f);
		fConst190 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst183))));
		float fConst191 = std::tan((1461.78308f / fConst0));
		float fConst192 = (1.0f / fConst191);
		float fConst193 = (((fConst192 + 0.25f) / fConst191) + 1.0f);
		float fConst194 = (fConst191 * fConst193);
		fConst195 = (1.0f / fConst194);
		fConst196 = (1.0f / fConst193);
		fConst197 = (((fConst192 + -0.25f) / fConst191) + 1.0f);
		fConst198 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst191))));
		float fConst199 = std::tan((1499.79639f / fConst0));
		float fConst200 = (1.0f / fConst199);
		float fConst201 = (((fConst200 + 0.25f) / fConst199) + 1.0f);
		float fConst202 = (fConst199 * fConst201);
		fConst203 = (1.0f / fConst202);
		fConst204 = (1.0f / fConst201);
		fConst205 = (((fConst200 + -0.25f) / fConst199) + 1.0f);
		fConst206 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst199))));
		fConst207 = (0.0f - (0.25f / fConst194));
		float fConst208 = std::tan((1328.89368f / fConst0));
		float fConst209 = (1.0f / fConst208);
		float fConst210 = (((fConst209 + 0.25f) / fConst208) + 1.0f);
		float fConst211 = (fConst208 * fConst210);
		fConst212 = (1.0f / fConst211);
		fConst213 = (1.0f / fConst210);
		fConst214 = (((fConst209 + -0.25f) / fConst208) + 1.0f);
		fConst215 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst208))));
		float fConst216 = std::tan((1378.21667f / fConst0));
		float fConst217 = (1.0f / fConst216);
		float fConst218 = (((fConst217 + 0.25f) / fConst216) + 1.0f);
		float fConst219 = (fConst216 * fConst218);
		fConst220 = (1.0f / fConst219);
		fConst221 = (1.0f / fConst218);
		fConst222 = (((fConst217 + -0.25f) / fConst216) + 1.0f);
		fConst223 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst216))));
		fConst224 = (0.0f - (0.300000012f / fConst219));
		fConst225 = (0.0f - (0.300000012f / fConst211));
		float fConst226 = std::tan((1213.91138f / fConst0));
		float fConst227 = (1.0f / fConst226);
		float fConst228 = (((fConst227 + 0.25f) / fConst226) + 1.0f);
		float fConst229 = (fConst226 * fConst228);
		fConst230 = (1.0f / fConst229);
		fConst231 = (1.0f / fConst228);
		fConst232 = (((fConst227 + -0.25f) / fConst226) + 1.0f);
		fConst233 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst226))));
		float fConst234 = std::tan((1265.11938f / fConst0));
		float fConst235 = (1.0f / fConst234);
		float fConst236 = (((fConst235 + 0.25f) / fConst234) + 1.0f);
		float fConst237 = (fConst234 * fConst236);
		fConst238 = (1.0f / fConst237);
		fConst239 = (1.0f / fConst236);
		fConst240 = (((fConst235 + -0.25f) / fConst234) + 1.0f);
		fConst241 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst234))));
		fConst242 = (0.0f - (0.349999994f / fConst237));
		fConst243 = (0.0f - (0.349999994f / fConst229));
		float fConst244 = std::tan((1075.36719f / fConst0));
		float fConst245 = (1.0f / fConst244);
		float fConst246 = (((fConst245 + 0.25f) / fConst244) + 1.0f);
		fConst247 = (0.400000006f / (fConst244 * fConst246));
		fConst248 = (0.0f - fConst247);
		fConst249 = (1.0f / fConst246);
		fConst250 = (((fConst245 + -0.25f) / fConst244) + 1.0f);
		fConst251 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst244))));
		float fConst252 = std::tan((990.858337f / fConst0));
		float fConst253 = (1.0f / fConst252);
		float fConst254 = (((fConst253 + 0.25f) / fConst252) + 1.0f);
		float fConst255 = (fConst252 * fConst254);
		fConst256 = (1.0f / fConst255);
		fConst257 = (1.0f / fConst254);
		fConst258 = (((fConst253 + -0.25f) / fConst252) + 1.0f);
		fConst259 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst252))));
		float fConst260 = std::tan((1007.50879f / fConst0));
		float fConst261 = (1.0f / fConst260);
		float fConst262 = (((fConst261 + 0.25f) / fConst260) + 1.0f);
		float fConst263 = (fConst260 * fConst262);
		fConst264 = (1.0f / fConst263);
		fConst265 = (1.0f / fConst262);
		fConst266 = (((fConst261 + -0.25f) / fConst260) + 1.0f);
		fConst267 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst260))));
		fConst268 = (0.0f - (0.449999988f / fConst263));
		float fConst269 = (1.0f / fConst20);
		float fConst270 = (((fConst269 + 0.25f) / fConst20) + 1.0f);
		fConst271 = (0.5f / (fConst20 * fConst270));
		fConst272 = (1.0f / fConst270);
		fConst273 = (((fConst269 + -0.25f) / fConst20) + 1.0f);
		fConst274 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst20))));
		fConst275 = (0.0f - fConst271);
		fConst276 = (0.0f - (0.25f / fConst178));
		fConst277 = (0.0f - (0.25f / fConst186));
		fConst278 = (0.0f - (0.449999988f / fConst255));
		fConst279 = (0.0f - (0.25f / fConst202));
		fConst280 = (0.0f - (0.200000003f / fConst161));
		fConst281 = (0.0f - (0.150000006f / fConst144));
		fConst282 = (0.0f - fConst137);
		...
		fConst321 = (0.0f - (0.300000012f / fConst308));
		float fConst322 = std::tan((565.486694f / fConst0));
		float fConst323 = (1.0f / fConst322);
		float fConst324 = (((fConst323 + 0.231481478f) / fConst322) + 1.0f);
		fConst325 = (1.0f / (fConst322 * fConst324));
		fConst326 = (0.0f - fConst325);
		fConst327 = (1.0f / fConst324);
		fConst328 = (((fConst323 + -0.231481478f) / fConst322) + 1.0f);
		fConst329 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst322))));
		fConst330 = (0.5f / fConst8);
		fConst331 = (0.0f - (0.300000012f / fConst300));
		fConst332 = (0.0f - (0.300000012f / fConst316));
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			float fTempFTZ26 = (fTemp18 - (fConst138 * ((fConst139 * fRec31[2]) + (fConst140 * fRec31[1]))));
			fRec31[0] = ((std::fabs(fTempFTZ26) > 1.17549435e-38f) ? fTempFTZ26 : 0.0f);
			float fTempFTZ27 = (fTemp18 - (fConst146 * ((fConst147 * fRec32[2]) + (fConst148 * fRec32[1]))));
			fRec32[0] = ((std::fabs(fTempFTZ27) > 1.17549435e-38f) ? fTempFTZ27 : 0.0f);
			float fTempFTZ28 = (fTemp18 - (fConst154 * ((fConst155 * fRec33[2]) + (fConst156 * fRec33[1]))));
			fRec33[0] = ((std::fabs(fTempFTZ28) > 1.17549435e-38f) ? fTempFTZ28 : 0.0f);
			float fTempFTZ29 = (fTemp18 - (fConst163 * ((fConst164 * fRec34[2]) + (fConst165 * fRec34[1]))));
			fRec34[0] = ((std::fabs(fTempFTZ29) > 1.17549435e-38f) ? fTempFTZ29 : 0.0f);
			float fTempFTZ30 = (fTemp18 - (fConst171 * ((fConst172 * fRec35[2]) + (fConst173 * fRec35[1]))));
			fRec35[0] = ((std::fabs(fTempFTZ30) > 1.17549435e-38f) ? fTempFTZ30 : 0.0f);
			float fTempFTZ31 = (fTemp18 - (fConst180 * ((fConst181 * fRec36[2]) + (fConst182 * fRec36[1]))));
			fRec36[0] = ((std::fabs(fTempFTZ31) > 1.17549435e-38f) ? fTempFTZ31 : 0.0f);
			float fTempFTZ32 = (fTemp18 - (fConst188 * ((fConst189 * fRec37[2]) + (fConst190 * fRec37[1]))));
			fRec37[0] = ((std::fabs(fTempFTZ32) > 1.17549435e-38f) ? fTempFTZ32 : 0.0f);
			float fTempFTZ33 = (fTemp18 - (fConst196 * ((fConst197 * fRec38[2]) + (fConst198 * fRec38[1]))));
			fRec38[0] = ((std::fabs(fTempFTZ33) > 1.17549435e-38f) ? fTempFTZ33 : 0.0f);
			float fTempFTZ34 = (fTemp18 - (fConst204 * ((fConst205 * fRec39[2]) + (fConst206 * fRec39[1]))));
			fRec39[0] = ((std::fabs(fTempFTZ34) > 1.17549435e-38f) ? fTempFTZ34 : 0.0f);
			float fTempFTZ35 = (fTemp18 - (fConst213 * ((fConst214 * fRec40[2]) + (fConst215 * fRec40[1]))));
			fRec40[0] = ((std::fabs(fTempFTZ35) > 1.17549435e-38f) ? fTempFTZ35 : 0.0f);
			float fTempFTZ36 = (fTemp18 - (fConst221 * ((fConst222 * fRec41[2]) + (fConst223 * fRec41[1]))));
			fRec41[0] = ((std::fabs(fTempFTZ36) > 1.17549435e-38f) ? fTempFTZ36 : 0.0f);
			float fTempFTZ37 = (fTemp18 - (fConst231 * ((fConst232 * fRec42[2]) + (fConst233 * fRec42[1]))));
			fRec42[0] = ((std::fabs(fTempFTZ37) > 1.17549435e-38f) ? fTempFTZ37 : 0.0f);
			float fTempFTZ38 = (fTemp18 - (fConst239 * ((fConst240 * fRec43[2]) + (fConst241 * fRec43[1]))));
			fRec43[0] = ((std::fabs(fTempFTZ38) > 1.17549435e-38f) ? fTempFTZ38 : 0.0f);
			float fTempFTZ39 = (fTemp18 - (fConst249 * ((fConst250 * fRec44[2]) + (fConst251 * fRec44[1]))));
			fRec44[0] = ((std::fabs(fTempFTZ39) > 1.17549435e-38f) ? fTempFTZ39 : 0.0f);
			float fTempFTZ40 = (fTemp18 - (fConst257 * ((fConst258 * fRec45[2]) + (fConst259 * fRec45[1]))));
			fRec45[0] = ((std::fabs(fTempFTZ40) > 1.17549435e-38f) ? fTempFTZ40 : 0.0f);
			float fTempFTZ41 = (fTemp18 - (fConst265 * ((fConst266 * fRec46[2]) + (fConst267 * fRec46[1]))));
			fRec46[0] = ((std::fabs(fTempFTZ41) > 1.17549435e-38f) ? fTempFTZ41 : 0.0f);
			float fTempFTZ42 = (fTemp18 - (fConst272 * ((fConst273 * fRec47[2]) + (fConst274 * fRec47[1]))));
			fRec47[0] = ((std::fabs(fTempFTZ42) > 1.17549435e-38f) ? fTempFTZ42 : 0.0f);
			float fTempFTZ43 = (((fConst14 * fRec2[2]) + (((fConst82 * fRec24[2]) + (((fConst90 * fRec25[2]) + (((fConst97 * fRec26[2]) + (((fConst105 * fRec27[2]) + (((0.0799999982f * ((fConst113 * fRec28[0]) + (fConst121 * fRec29[0]))) + ((fConst125 * fRec29[2]) + (((fConst130 * fRec30[2]) + (((fConst137 * fRec31[0]) + ((0.150000006f * ((fConst145 * fRec32[0]) + (fConst153 * fRec33[0]))) + (((fConst157 * fRec33[2]) + (((0.200000003f * ((fConst162 * fRec34[0]) + (fConst170 * fRec35[0]))) + ((fConst174 * fRec35[2]) + (((0.25f * ((((fTemp17 + (fConst179 * fRec36[0])) + (fConst187 * fRec37[0])) + (fConst195 * fRec38[0])) + (fConst203 * fRec39[0]))) + (((fConst207 * fRec38[2]) + ((0.300000012f * ((fConst212 * fRec40[0]) + (fConst220 * fRec41[0]))) + ((fConst224 * fRec41[2]) + ((fConst225 * fRec40[2]) + ((0.349999994f * ((fConst230 * fRec42[0]) + (fConst238 * fRec43[0]))) + ((fConst242 * fRec43[2]) + ((fConst243 * fRec42[2]) + ((fConst248 * fRec44[2]) + ((fConst247 * fRec44[0]) + ((0.449999988f * ((fConst256 * fRec45[0]) + (fConst264 * fRec46[0]))) + ((fConst268 * fRec46[2]) + (((((fConst271 * fRec47[0]) + (fConst275 * fRec47[2])) + (fConst276 * fRec36[2])) + (fConst277 * fRec37[2])) + (fConst278 * fRec45[2]))))))))))))) + (fConst279 * fRec39[2]))) + (fConst280 * fRec34[2])))) + (fConst281 * fRec32[2]))) + (fConst282 * fRec31[2])))) + (fConst129 * fRec30[0]))) + (fConst283 * fRec28[2])))) + (fConst104 * fRec27[0]))) + (fConst96 * fRec26[0]))) + (fConst89 * fRec25[0]))) + (fConst81 * fRec24[0]))) + (fConst13 * fRec2[0]))) - (fConst9 * ((fConst284 * fRec1[2]) + (fConst285 * fRec1[1]))));
			...
			float fTempFTZ49 = (fTemp20 - (fConst327 * ((fConst328 * fRec52[2]) + (fConst329 * fRec52[1]))));
			fRec52[0] = ((std::fabs(fTempFTZ49) > 1.17549435e-38f) ? fTempFTZ49 : 0.0f);
			float fTemp21 = ((fConst5 * fRec0[2]) + (((fConst293 * fRec48[2]) + (((0.300000012f * (((fConst301 * fRec49[0]) + (fConst309 * fRec50[0])) + (fConst317 * fRec51[0]))) + (((fConst321 * fRec50[2]) + (((fConst326 * fRec52[2]) + ((fConst330 * fTemp19) + (fConst325 * fRec52[0]))) + (fConst331 * fRec49[2]))) + (fConst332 * fRec51[2]))) + (fConst292 * fRec48[0]))) + (fConst4 * fRec0[0])));
			float fTemp22 = (fSlow10 * fTemp21);
			float fTemp23 = ((0.996999979f * fRec53[1]) + fTemp22);
			fVec9[(IOTA & 2047)] = fTemp23;
			...
			float fTemp24 = (fTemp22 + (0.996999979f * fRec54[1]));
			fVec10[(IOTA & 1023)] = fTemp24;
			...
			float fTemp25 = (fTemp22 + (0.996999979f * fRec55[1]));
			fVec11[(IOTA & 1023)] = fTemp25;
			...
			output0[i0] = FAUSTFLOAT((fSlow0 * (fTemp21 + (fSlow56 * ((fRec53[0] + fRec54[0]) + fRec55[0])))));
			iRec5[1] = iRec5[0];
