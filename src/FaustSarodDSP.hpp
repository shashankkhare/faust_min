...
class FaustSarodDSP : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		float fConst17 = std::tan((37699.1133f / fConst0));
		float fConst18 = (fConst0 * fConst17);
		float fConst19 = (2.0f * fConst18);
		float fConst20 = (FaustSarodDSP_faustpower2_f(fConst0) * fConst17);
		float fConst21 = std::sqrt((4.0f * (fConst20 * std::tan((314.159271f / fConst0)))));
		float fConst22 = FaustSarodDSP_faustpower2_f(fConst21);
		float fConst23 = (fConst19 - (0.5f * (fConst22 / fConst18)));
		...
		fConst32 = (0.180000007f * (fConst16 / fConst31));
		fConst33 = (44.0999985f / fConst0);
		fConst34 = (1.0f - fConst33);
		float fConst35 = (8.0f * fConst24);
		fConst36 = (0.0f - fConst35);
		fConst37 = (1.0f / fConst31);
		float fConst38 = FaustSarodDSP_faustpower3_f(fConst15);
		float fConst39 = (fConst38 * fConst22);
		float fConst40 = (5.65685415f * fConst23);
		float fConst41 = (4.0f * fConst27);
		float fConst42 = (22.6274166f * fConst29);
		fConst43 = ((fConst39 * (fConst40 + fConst41)) + (-64.0f - fConst42));
		fConst44 = ((fConst16 * ((0.0f - (fConst35 + (16.0f * fConst22))) + (6.0f * (fConst16 * FaustSarodDSP_faustpower4_f(fConst21))))) + 96.0f);
		fConst45 = ((fConst42 + (fConst39 * (fConst41 - fConst40))) + -64.0f);
		fConst46 = ((fConst16 * (fConst26 + (fConst27 * (fConst27 - fConst28)))) + (16.0f - fConst30));
		fConst47 = std::max<float>(1.0f, (0.00300000003f * fConst0));
		fConst48 = (1.0f / fConst47);
		fConst49 = (1.0f / std::max<float>(1.0f, (0.0149999997f * fConst0)));
		fConst50 = std::exp((0.0f - (33.3333321f / fConst0)));
		fConst51 = (1.0f - fConst50);
		float fConst52 = std::tan((471.238892f / fConst0));
		float fConst53 = std::sqrt((4.0f * (fConst20 * fConst52)));
		float fConst54 = FaustSarodDSP_faustpower2_f(fConst53);
		float fConst55 = (fConst19 - (0.5f * (fConst54 / fConst18)));
		float fConst56 = FaustSarodDSP_faustpower2_f(fConst55);
		fConst57 = (4.0f * fConst56);
		float fConst58 = (fConst57 + (8.0f * fConst54));
		float fConst59 = (fConst15 * fConst54);
		float fConst60 = (2.82842708f * fConst55);
		float fConst61 = (fConst55 / fConst0);
		float fConst62 = (11.3137083f * fConst61);
		float fConst63 = (((fConst16 * (fConst58 + (fConst59 * (fConst60 + fConst59)))) + fConst62) + 16.0f);
		fConst64 = (0.0500000007f * (fConst16 / fConst63));
		float fConst65 = (8.0f * fConst56);
		fConst66 = (0.0f - fConst65);
		fConst67 = (1.0f / fConst63);
		float fConst68 = (fConst38 * fConst54);
		float fConst69 = (5.65685415f * fConst55);
		float fConst70 = (4.0f * fConst59);
		float fConst71 = (22.6274166f * fConst61);
		fConst72 = ((fConst68 * (fConst69 + fConst70)) + (-64.0f - fConst71));
		fConst73 = ((fConst16 * ((0.0f - (fConst65 + (16.0f * fConst54))) + (6.0f * (fConst16 * FaustSarodDSP_faustpower4_f(fConst53))))) + 96.0f);
		fConst74 = ((fConst71 + (fConst68 * (fConst70 - fConst69))) + -64.0f);
		fConst75 = ((fConst16 * (fConst58 + (fConst59 * (fConst59 - fConst60)))) + (16.0f - fConst62));
		float fConst76 = (1.0f / fConst17);
		fConst77 = (1.0f / (((fConst76 + 1.41421354f) / fConst17) + 1.0f));
		fConst78 = (((fConst76 + -1.41421354f) / fConst17) + 1.0f);
		fConst79 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst17))));
		fConst80 = (1.0f / fConst12);
		fConst81 = (((fConst11 + -0.400000006f) / fConst10) + 1.0f);
		fConst82 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst10))));
		float fConst83 = std::tan((8168.14111f / fConst0));
		float fConst84 = (1.0f / fConst83);
		float fConst85 = (((fConst84 + 0.400000006f) / fConst83) + 1.0f);
		fConst86 = (0.600000024f / (fConst83 * fConst85));
		fConst87 = (0.0f - fConst86);
		fConst88 = (1.0f / fConst85);
		fConst89 = (((fConst84 + -0.400000006f) / fConst83) + 1.0f);
		fConst90 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst83))));
		float fConst91 = (((fConst2 + 0.400000006f) / fConst1) + 1.0f);
		fConst92 = (0.649999976f / (fConst1 * fConst91));
		fConst93 = (0.0f - fConst92);
		fConst94 = (1.0f / fConst91);
		fConst95 = (((fConst2 + -0.400000006f) / fConst1) + 1.0f);
		fConst96 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst1))));
		float fConst97 = std::tan((3769.91113f / fConst0));
		float fConst98 = (1.0f / fConst97);
		float fConst99 = (((fConst98 + 0.400000006f) / fConst97) + 1.0f);
		fConst100 = (0.400000006f / (fConst97 * fConst99));
		fConst101 = (0.0f - fConst100);
		fConst102 = (1.0f / fConst99);
		fConst103 = (((fConst98 + -0.400000006f) / fConst97) + 1.0f);
		fConst104 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst97))));
		float fConst105 = (1.0f / fConst52);
		float fConst106 = (((fConst105 + 0.333333343f) / fConst52) + 1.0f);
		float fConst107 = (fConst52 * fConst106);
		fConst108 = (1.0f / fConst107);
		fConst109 = (1.0f / fConst106);
		fConst110 = (((fConst105 + -0.333333343f) / fConst52) + 1.0f);
		fConst111 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst52))));
		float fConst112 = std::tan((743.61499f / fConst0));
		float fConst113 = (1.0f / fConst112);
		float fConst114 = (((fConst113 + 0.333333343f) / fConst112) + 1.0f);
		float fConst115 = (fConst112 * fConst114);
		fConst116 = (1.0f / fConst115);
		fConst117 = (1.0f / fConst114);
		fConst118 = (((fConst113 + -0.333333343f) / fConst112) + 1.0f);
		fConst119 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst112))));
		float fConst120 = std::tan((754.610535f / fConst0));
		float fConst121 = (1.0f / fConst120);
		float fConst122 = (((fConst121 + 0.333333343f) / fConst120) + 1.0f);
		float fConst123 = (fConst120 * fConst122);
		fConst124 = (1.0f / fConst123);
		fConst125 = (1.0f / fConst122);
		fConst126 = (((fConst121 + -0.333333343f) / fConst120) + 1.0f);
		fConst127 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst120))));
		float fConst128 = std::tan((990.858337f / fConst0));
		float fConst129 = (1.0f / fConst128);
		float fConst130 = (((fConst129 + 0.333333343f) / fConst128) + 1.0f);
		float fConst131 = (fConst128 * fConst130);
		fConst132 = (1.0f / fConst131);
		fConst133 = (1.0f / fConst130);
		fConst134 = (((fConst129 + -0.333333343f) / fConst128) + 1.0f);
		fConst135 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst128))));
		float fConst136 = std::tan((1007.50879f / fConst0));
		float fConst137 = (1.0f / fConst136);
		float fConst138 = (((fConst137 + 0.333333343f) / fConst136) + 1.0f);
		float fConst139 = (fConst136 * fConst138);
		fConst140 = (1.0f / fConst139);
		fConst141 = (1.0f / fConst138);
		fConst142 = (((fConst137 + -0.333333343f) / fConst136) + 1.0f);
		fConst143 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst136))));
		float fConst144 = std::tan((1075.36719f / fConst0));
		float fConst145 = (1.0f / fConst144);
		float fConst146 = (((fConst145 + 0.333333343f) / fConst144) + 1.0f);
		float fConst147 = (fConst144 * fConst146);
		fConst148 = (1.0f / fConst147);
		fConst149 = (1.0f / fConst146);
		fConst150 = (((fConst145 + -0.333333343f) / fConst144) + 1.0f);
		fConst151 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst144))));
		float fConst152 = std::tan((1213.91138f / fConst0));
		float fConst153 = (1.0f / fConst152);
		float fConst154 = (((fConst153 + 0.333333343f) / fConst152) + 1.0f);
		float fConst155 = (fConst152 * fConst154);
		fConst156 = (1.0f / fConst155);
		fConst157 = (1.0f / fConst154);
		fConst158 = (((fConst153 + -0.333333343f) / fConst152) + 1.0f);
		fConst159 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst152))));
		float fConst160 = std::tan((1265.11938f / fConst0));
		float fConst161 = (1.0f / fConst160);
		float fConst162 = (((fConst161 + 0.333333343f) / fConst160) + 1.0f);
		float fConst163 = (fConst160 * fConst162);
		fConst164 = (1.0f / fConst163);
		fConst165 = (1.0f / fConst162);
		fConst166 = (((fConst161 + -0.333333343f) / fConst160) + 1.0f);
		fConst167 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst160))));
		float fConst168 = std::tan((1461.78308f / fConst0));
		float fConst169 = (1.0f / fConst168);
		float fConst170 = (((fConst169 + 0.333333343f) / fConst168) + 1.0f);
		float fConst171 = (fConst168 * fConst170);
		fConst172 = (1.0f / fConst171);
		fConst173 = (1.0f / fConst170);
		fConst174 = (((fConst169 + -0.333333343f) / fConst168) + 1.0f);
		fConst175 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst168))));
		float fConst176 = std::tan((1499.79639f / fConst0));
		float fConst177 = (1.0f / fConst176);
		float fConst178 = (((fConst177 + 0.333333343f) / fConst176) + 1.0f);
		float fConst179 = (fConst176 * fConst178);
		fConst180 = (1.0f / fConst179);
		fConst181 = (1.0f / fConst178);
		fConst182 = (((fConst177 + -0.333333343f) / fConst176) + 1.0f);
		fConst183 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst176))));
		float fConst184 = std::tan((1683.57947f / fConst0));
		float fConst185 = (1.0f / fConst184);
		float fConst186 = (((fConst185 + 0.333333343f) / fConst184) + 1.0f);
		float fConst187 = (fConst184 * fConst186);
		fConst188 = (1.0f / fConst187);
		fConst189 = (1.0f / fConst186);
		fConst190 = (((fConst185 + -0.333333343f) / fConst184) + 1.0f);
		fConst191 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst184))));
		float fConst192 = std::tan((1709.65466f / fConst0));
		float fConst193 = (1.0f / fConst192);
		float fConst194 = (((fConst193 + 0.333333343f) / fConst192) + 1.0f);
		float fConst195 = (fConst192 * fConst194);
		fConst196 = (1.0f / fConst195);
		fConst197 = (1.0f / fConst194);
		fConst198 = (((fConst193 + -0.333333343f) / fConst192) + 1.0f);
		fConst199 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst192))));
		float fConst200 = std::tan((2670.35376f / fConst0));
		...
		fConst223 = (((fConst218 + -0.333333343f) / fConst217) + 1.0f);
		fConst224 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst217))));
		float fConst225 = std::tan((1378.21667f / fConst0));
		float fConst226 = (1.0f / fConst225);
		float fConst227 = (((fConst226 + 0.333333343f) / fConst225) + 1.0f);
		float fConst228 = (fConst225 * fConst227);
		fConst229 = (1.0f / fConst228);
		fConst230 = (1.0f / fConst227);
		fConst231 = (((fConst226 + -0.333333343f) / fConst225) + 1.0f);
		fConst232 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst225))));
		float fConst233 = std::tan((1565.76978f / fConst0));
		float fConst234 = (1.0f / fConst233);
		float fConst235 = (((fConst234 + 0.333333343f) / fConst233) + 1.0f);
		float fConst236 = (fConst233 * fConst235);
		fConst237 = (1.0f / fConst236);
		fConst238 = (1.0f / fConst235);
		fConst239 = (((fConst234 + -0.333333343f) / fConst233) + 1.0f);
		fConst240 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst233))));
		float fConst241 = std::tan((1642.73877f / fConst0));
		float fConst242 = (1.0f / fConst241);
		float fConst243 = (((fConst242 + 0.333333343f) / fConst241) + 1.0f);
		float fConst244 = (fConst241 * fConst243);
		fConst245 = (1.0f / fConst244);
		fConst246 = (1.0f / fConst243);
		fConst247 = (((fConst242 + -0.333333343f) / fConst241) + 1.0f);
		fConst248 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst241))));
		float fConst249 = std::tan((1739.18567f / fConst0));
		float fConst250 = (1.0f / fConst249);
		float fConst251 = (((fConst250 + 0.333333343f) / fConst249) + 1.0f);
		float fConst252 = (fConst249 * fConst251);
		fConst253 = (1.0f / fConst252);
		fConst254 = (1.0f / fConst251);
		fConst255 = (((fConst250 + -0.333333343f) / fConst249) + 1.0f);
		fConst256 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst249))));
		float fConst257 = std::tan((1801.07507f / fConst0));
		float fConst258 = (1.0f / fConst257);
		float fConst259 = (((fConst258 + 0.333333343f) / fConst257) + 1.0f);
		float fConst260 = (fConst257 * fConst259);
		fConst261 = (1.0f / fConst260);
		fConst262 = (1.0f / fConst259);
		fConst263 = (((fConst258 + -0.333333343f) / fConst257) + 1.0f);
		fConst264 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst257))));
		float fConst265 = std::tan((1905.69006f / fConst0));
		float fConst266 = (1.0f / fConst265);
		float fConst267 = (((fConst266 + 0.333333343f) / fConst265) + 1.0f);
		float fConst268 = (fConst265 * fConst267);
		fConst269 = (1.0f / fConst268);
		fConst270 = (1.0f / fConst267);
		fConst271 = (((fConst266 + -0.333333343f) / fConst265) + 1.0f);
		fConst272 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst265))));
		fConst273 = (0.0f - (0.219999999f / fConst268));
		fConst274 = (0.0f - (0.219999999f / fConst260));
		fConst275 = (0.0f - (0.219999999f / fConst252));
		fConst276 = (0.0f - (0.25f / fConst195));
		fConst277 = (0.0f - (0.25f / fConst187));
		fConst278 = (0.0f - (0.219999999f / fConst244));
		fConst279 = (0.0f - (0.219999999f / fConst236));
		fConst280 = (0.0f - (0.25f / fConst179));
		fConst281 = (0.0f - (0.25f / fConst171));
		fConst282 = (0.0f - (0.219999999f / fConst228));
		fConst283 = (0.0f - (0.25f / fConst115));
		fConst284 = (0.0f - (0.25f / fConst107));
		fConst285 = (0.0f - (0.25f / fConst123));
		fConst286 = (0.0f - (0.25f / fConst131));
		fConst287 = (0.0f - (0.25f / fConst139));
		fConst288 = (0.0f - (0.25f / fConst147));
		fConst289 = (0.0f - (0.25f / fConst155));
		fConst290 = (0.0f - (0.25f / fConst163));
		fConst291 = (0.0f - (0.219999999f / fConst220));
		fConst292 = (((fConst7 + -1.41421354f) / fConst6) + 1.0f);
		fConst293 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst6))));
		fConst294 = (1.0f / fConst3);
		fConst295 = (((fConst2 + -0.333333343f) / fConst1) + 1.0f);
		float fConst296 = (((fConst98 + 0.333333343f) / fConst97) + 1.0f);
		fConst297 = (0.800000012f / (fConst97 * fConst296));
		fConst298 = (0.0f - fConst297);
		fConst299 = (1.0f / fConst296);
		fConst300 = (((fConst98 + -0.333333343f) / fConst97) + 1.0f);
		float fConst301 = std::tan((3298.67236f / fConst0));
		float fConst302 = (1.0f / fConst301);
		float fConst303 = (((fConst302 + 0.285714298f) / fConst301) + 1.0f);
		fConst304 = (0.899999976f / (fConst301 * fConst303));
		fConst305 = (0.0f - fConst304);
		fConst306 = (1.0f / fConst303);
		fConst307 = (((fConst302 + -0.285714298f) / fConst301) + 1.0f);
		fConst308 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst301))));
		float fConst309 = std::tan((2984.51294f / fConst0));
		float fConst310 = (1.0f / fConst309);
		float fConst311 = (((fConst310 + 0.285714298f) / fConst309) + 1.0f);
		fConst312 = (0.850000024f / (fConst309 * fConst311));
		fConst313 = (0.0f - fConst312);
		fConst314 = (1.0f / fConst311);
		fConst315 = (((fConst310 + -0.285714298f) / fConst309) + 1.0f);
		fConst316 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst309))));
		float fConst317 = std::tan((1727.87598f / fConst0));
		float fConst318 = (1.0f / fConst317);
		float fConst319 = (((fConst318 + 0.25f) / fConst317) + 1.0f);
		fConst320 = (1.29999995f / (fConst317 * fConst319));
		fConst321 = (0.0f - fConst320);
		fConst322 = (1.0f / fConst319);
		fConst323 = (((fConst318 + -0.25f) / fConst317) + 1.0f);
		fConst324 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst317))));
		float fConst325 = std::tan((1005.30963f / fConst0));
		float fConst326 = (1.0f / fConst325);
		float fConst327 = (((fConst326 + 0.400000006f) / fConst325) + 1.0f);
		fConst328 = (1.89999998f / (fConst325 * fConst327));
		fConst329 = (0.0f - fConst328);
		fConst330 = (1.0f / fConst327);
		fConst331 = (((fConst326 + -0.400000006f) / fConst325) + 1.0f);
		fConst332 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst325))));
		float fConst333 = std::tan((565.486694f / fConst0));
		float fConst334 = (1.0f / fConst333);
		float fConst335 = (((fConst334 + 0.400000006f) / fConst333) + 1.0f);
		fConst336 = (1.45000005f / (fConst333 * fConst335));
		fConst337 = (0.0f - fConst336);
		fConst338 = (1.0f / fConst335);
		fConst339 = (((fConst334 + -0.400000006f) / fConst333) + 1.0f);
		fConst340 = (2.0f * (1.0f - (1.0f / FaustSarodDSP_faustpower2_f(fConst333))));
		fConst341 = (0.349999994f / fConst8);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("freq", &fHslider1, FAUSTFLOAT(146.830002f), FAUSTFLOAT(130.0f), FAUSTFLOAT(900.0f), FAUSTFLOAT(0.00999999978f));
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow16 = (fConst32 * (fSlow15 * fSlow4));
		float fSlow17 = (fConst33 * std::max<float>(fSlow1, float(iSlow3)));
		...
		float fSlow24 = (fConst64 * fSlow15);
		...
		float fSlow83 = (fConst77 * float(fHslider11));
		float fSlow84 = (fConst33 * fSlow1);
		...
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			float fTempFTZ4 = (fSlow17 + (fConst34 * fRec9[1]));
			...
			float fTempFTZ5 = (fTemp11 - (fConst37 * ((((fConst43 * fRec10[1]) + (fConst44 * fRec10[2])) + (fConst45 * fRec10[3])) + (fConst46 * fRec10[4]))));
			...
			fVec5[(IOTA & 8191)] = ((((fTemp10 > 0.0f) ? fElse1 : fThen1) * std::pow(0.00100000005f, (1.0f / (fTemp3 * std::max<float>(0.400000006f, (fSlow14 * (4.0f - (1.70000005f * std::max<float>(0.0f, std::min<float>(1.0f, (0.00138888892f * (fRec5[0] + -80.0f)))))))))))) + (fSlow16 * ((fRec9[0] * (((fConst36 * fRec10[2]) + (fConst25 * fRec10[0])) + (fConst25 * fRec10[4]))) * std::max<float>(0.0f, std::min<float>((fConst48 * fTemp13), (1.0f - (fConst49 * (fTemp13 - fConst47))))))));
			...
			float fTempFTZ8 = std::max<float>(fTemp14, ((fConst50 * fRec14[1]) + (fConst51 * fTemp14)));
			...
			float fTempFTZ10 = (fTemp11 - (fConst67 * ((((fConst72 * fRec18[1]) + (fConst73 * fRec18[2])) + (fConst74 * fRec18[3])) + (fConst75 * fRec18[4]))));
			...
			float fTemp23 = (fSlow24 * (((((fConst66 * fRec18[2]) + (fConst57 * fRec18[0])) + (fConst57 * fRec18[4])) * std::max<float>(0.0f, std::min<float>((fConst48 * fTemp22), (1.0f - (fConst49 * (fTemp22 - fConst47)))))) * float(iTemp20)));
			...
			float fTempFTZ14 = std::max<float>(fTemp26, ((fConst50 * fRec16[1]) + (fConst51 * fTemp26)));
			...
			float fTempFTZ18 = std::max<float>(fTemp33, ((fConst50 * fRec23[1]) + (fConst51 * fTemp33)));
			...
			float fTempFTZ22 = std::max<float>(fTemp40, ((fConst50 * fRec27[1]) + (fConst51 * fTemp40)));
			...
			float fTempFTZ26 = std::max<float>(fTemp47, ((fConst50 * fRec33[1]) + (fConst51 * fTemp47)));
			...
			float fTempFTZ28 = (fSlow84 + (fConst34 * fRec37[1]));
			fRec37[0] = ((std::fabs(fTempFTZ28) > 1.17549435e-38f) ? fTempFTZ28 : 0.0f);
			float fTempFTZ29 = ((fSlow85 * fTemp52) - (fConst77 * ((fConst78 * fRec38[2]) + (fConst79 * fRec38[1]))));
			...
			fVec16[(IOTA & 1023)] = (fTemp53 + (fSlow86 * ((fTemp55 > 0.0f) ? fElse8 : fThen8)));
			float fTempFTZ31 = fVec16[((IOTA - iSlow94) & 1023)];
			fRec36[(IOTA & 2047)] = ((std::fabs(fTempFTZ31) > 1.17549435e-38f) ? fTempFTZ31 : 0.0f);
			float fTemp56 = std::fabs(fRec36[((IOTA - 0) & 2047)]);
			float fTempFTZ32 = std::max<float>(fTemp56, ((fConst50 * fRec35[1]) + (fConst51 * fTemp56)));
			...
			fVec18[(IOTA & 1023)] = (fTemp53 + (fSlow99 * ((fTemp62 > 0.0f) ? fElse9 : fThen9)));
			float fTempFTZ35 = fVec18[((IOTA - iSlow107) & 1023)];
			fRec42[(IOTA & 2047)] = ((std::fabs(fTempFTZ35) > 1.17549435e-38f) ? fTempFTZ35 : 0.0f);
			float fTemp63 = std::fabs(fRec42[((IOTA - 0) & 2047)]);
			float fTempFTZ36 = std::max<float>(fTemp63, ((fConst50 * fRec41[1]) + (fConst51 * fTemp63)));
			...
			fVec20[(IOTA & 2047)] = ((fSlow111 * ((fTemp69 > 0.0f) ? fElse10 : fThen10)) + fTemp53);
			float fTempFTZ39 = fVec20[((IOTA - iSlow119) & 2047)];
			fRec45[(IOTA & 2047)] = ((std::fabs(fTempFTZ39) > 1.17549435e-38f) ? fTempFTZ39 : 0.0f);
			float fTemp70 = std::fabs(fRec45[((IOTA - 0) & 2047)]);
			float fTempFTZ40 = std::max<float>(fTemp70, ((fConst50 * fRec47[1]) + (fConst51 * fTemp70)));
			...
			float fTempFTZ42 = (fTemp75 - (fConst80 * ((fConst81 * fRec2[2]) + (fConst82 * fRec2[1]))));
			fRec2[0] = ((std::fabs(fTempFTZ42) > 1.17549435e-38f) ? fTempFTZ42 : 0.0f);
			float fTempFTZ43 = (fTemp75 - (fConst88 * ((fConst89 * fRec49[2]) + (fConst90 * fRec49[1]))));
			fRec49[0] = ((std::fabs(fTempFTZ43) > 1.17549435e-38f) ? fTempFTZ43 : 0.0f);
			float fTempFTZ44 = (fTemp75 - (fConst94 * ((fConst95 * fRec50[2]) + (fConst96 * fRec50[1]))));
			fRec50[0] = ((std::fabs(fTempFTZ44) > 1.17549435e-38f) ? fTempFTZ44 : 0.0f);
			float fTempFTZ45 = (fTemp75 - (fConst102 * ((fConst103 * fRec51[2]) + (fConst104 * fRec51[1]))));
			fRec51[0] = ((std::fabs(fTempFTZ45) > 1.17549435e-38f) ? fTempFTZ45 : 0.0f);
			float fTempFTZ46 = (fTemp75 - (fConst109 * ((fConst110 * fRec52[2]) + (fConst111 * fRec52[1]))));
			fRec52[0] = ((std::fabs(fTempFTZ46) > 1.17549435e-38f) ? fTempFTZ46 : 0.0f);
			float fTempFTZ47 = (fTemp75 - (fConst117 * ((fConst118 * fRec53[2]) + (fConst119 * fRec53[1]))));
			fRec53[0] = ((std::fabs(fTempFTZ47) > 1.17549435e-38f) ? fTempFTZ47 : 0.0f);
			float fTempFTZ48 = (fTemp75 - (fConst125 * ((fConst126 * fRec54[2]) + (fConst127 * fRec54[1]))));
			fRec54[0] = ((std::fabs(fTempFTZ48) > 1.17549435e-38f) ? fTempFTZ48 : 0.0f);
			float fTempFTZ49 = (fTemp75 - (fConst133 * ((fConst134 * fRec55[2]) + (fConst135 * fRec55[1]))));
			fRec55[0] = ((std::fabs(fTempFTZ49) > 1.17549435e-38f) ? fTempFTZ49 : 0.0f);
			float fTempFTZ50 = (fTemp75 - (fConst141 * ((fConst142 * fRec56[2]) + (fConst143 * fRec56[1]))));
			fRec56[0] = ((std::fabs(fTempFTZ50) > 1.17549435e-38f) ? fTempFTZ50 : 0.0f);
			float fTempFTZ51 = (fTemp75 - (fConst149 * ((fConst150 * fRec57[2]) + (fConst151 * fRec57[1]))));
			fRec57[0] = ((std::fabs(fTempFTZ51) > 1.17549435e-38f) ? fTempFTZ51 : 0.0f);
			float fTempFTZ52 = (fTemp75 - (fConst157 * ((fConst158 * fRec58[2]) + (fConst159 * fRec58[1]))));
			fRec58[0] = ((std::fabs(fTempFTZ52) > 1.17549435e-38f) ? fTempFTZ52 : 0.0f);
			float fTempFTZ53 = (fTemp75 - (fConst165 * ((fConst166 * fRec59[2]) + (fConst167 * fRec59[1]))));
			fRec59[0] = ((std::fabs(fTempFTZ53) > 1.17549435e-38f) ? fTempFTZ53 : 0.0f);
			float fTempFTZ54 = (fTemp75 - (fConst173 * ((fConst174 * fRec60[2]) + (fConst175 * fRec60[1]))));
			fRec60[0] = ((std::fabs(fTempFTZ54) > 1.17549435e-38f) ? fTempFTZ54 : 0.0f);
			float fTempFTZ55 = (fTemp75 - (fConst181 * ((fConst182 * fRec61[2]) + (fConst183 * fRec61[1]))));
			fRec61[0] = ((std::fabs(fTempFTZ55) > 1.17549435e-38f) ? fTempFTZ55 : 0.0f);
			float fTempFTZ56 = (fTemp75 - (fConst189 * ((fConst190 * fRec62[2]) + (fConst191 * fRec62[1]))));
			fRec62[0] = ((std::fabs(fTempFTZ56) > 1.17549435e-38f) ? fTempFTZ56 : 0.0f);
			float fTempFTZ57 = (fTemp75 - (fConst197 * ((fConst198 * fRec63[2]) + (fConst199 * fRec63[1]))));
			fRec63[0] = ((std::fabs(fTempFTZ57) > 1.17549435e-38f) ? fTempFTZ57 : 0.0f);
			float fTempFTZ58 = (fTemp75 - (fConst205 * ((fConst206 * fRec64[2]) + (fConst207 * fRec64[1]))));
			fRec64[0] = ((std::fabs(fTempFTZ58) > 1.17549435e-38f) ? fTempFTZ58 : 0.0f);
			float fTempFTZ59 = (fTemp75 - (fConst214 * ((fConst215 * fRec65[2]) + (fConst216 * fRec65[1]))));
			fRec65[0] = ((std::fabs(fTempFTZ59) > 1.17549435e-38f) ? fTempFTZ59 : 0.0f);
			float fTempFTZ60 = (fTemp75 - (fConst222 * ((fConst223 * fRec66[2]) + (fConst224 * fRec66[1]))));
			fRec66[0] = ((std::fabs(fTempFTZ60) > 1.17549435e-38f) ? fTempFTZ60 : 0.0f);
			float fTempFTZ61 = (fTemp75 - (fConst230 * ((fConst231 * fRec67[2]) + (fConst232 * fRec67[1]))));
			fRec67[0] = ((std::fabs(fTempFTZ61) > 1.17549435e-38f) ? fTempFTZ61 : 0.0f);
			float fTempFTZ62 = (fTemp75 - (fConst238 * ((fConst239 * fRec68[2]) + (fConst240 * fRec68[1]))));
			fRec68[0] = ((std::fabs(fTempFTZ62) > 1.17549435e-38f) ? fTempFTZ62 : 0.0f);
			float fTempFTZ63 = (fTemp75 - (fConst246 * ((fConst247 * fRec69[2]) + (fConst248 * fRec69[1]))));
			fRec69[0] = ((std::fabs(fTempFTZ63) > 1.17549435e-38f) ? fTempFTZ63 : 0.0f);
			float fTempFTZ64 = (fTemp75 - (fConst254 * ((fConst255 * fRec70[2]) + (fConst256 * fRec70[1]))));
			fRec70[0] = ((std::fabs(fTempFTZ64) > 1.17549435e-38f) ? fTempFTZ64 : 0.0f);
			float fTempFTZ65 = (fTemp75 - (fConst262 * ((fConst263 * fRec71[2]) + (fConst264 * fRec71[1]))));
			fRec71[0] = ((std::fabs(fTempFTZ65) > 1.17549435e-38f) ? fTempFTZ65 : 0.0f);
			float fTempFTZ66 = (fTemp75 - (fConst270 * ((fConst271 * fRec72[2]) + (fConst272 * fRec72[1]))));
			fRec72[0] = ((std::fabs(fTempFTZ66) > 1.17549435e-38f) ? fTempFTZ66 : 0.0f);
			float fTempFTZ67 = (((fConst14 * fRec2[2]) + (((fConst87 * fRec49[2]) + (((fConst93 * fRec50[2]) + (((fConst101 * fRec51[2]) + (((0.25f * (((((((((((((fConst108 * fRec52[0]) + (fConst116 * fRec53[0])) + (fConst124 * fRec54[0])) + (fConst132 * fRec55[0])) + (fConst140 * fRec56[0])) + (fConst148 * fRec57[0])) + (fConst156 * fRec58[0])) + (fConst164 * fRec59[0])) + (fConst172 * fRec60[0])) + (fConst180 * fRec61[0])) + (fConst188 * fRec62[0])) + (fConst196 * fRec63[0])) + (fConst204 * fRec64[0]))) + ((fConst208 * fRec64[2]) + ((fConst213 * fRec65[2]) + ((fConst212 * fRec65[0]) + ((0.219999999f * (((((((fConst221 * fRec66[0]) + (fConst229 * fRec67[0])) + (fConst237 * fRec68[0])) + (fConst245 * fRec69[0])) + (fConst253 * fRec70[0])) + (fConst261 * fRec71[0])) + (fConst269 * fRec72[0]))) + ((fConst273 * fRec72[2]) + ((fConst274 * fRec71[2]) + ((fConst275 * fRec70[2]) + ((fConst276 * fRec63[2]) + ((fConst277 * fRec62[2]) + ((fConst278 * fRec69[2]) + ((fConst279 * fRec68[2]) + ((fConst280 * fRec61[2]) + ((fConst281 * fRec60[2]) + ((fConst282 * fRec67[2]) + (((((((((fConst283 * fRec53[2]) + ((0.150000006f * fTemp75) + (fConst284 * fRec52[2]))) + (fConst285 * fRec54[2])) + (fConst286 * fRec55[2])) + (fConst287 * fRec56[2])) + (fConst288 * fRec57[2])) + (fConst289 * fRec58[2])) + (fConst290 * fRec59[2])) + (fConst291 * fRec66[2]))))))))))))))))) + (fConst100 * fRec51[0]))) + (fConst92 * fRec50[0]))) + (fConst86 * fRec49[0]))) + (fConst13 * fRec2[0]))) - (fConst9 * ((fConst292 * fRec1[2]) + (fConst293 * fRec1[1]))));
			...
			float fTempFTZ68 = (fTemp77 - (fConst294 * ((fConst295 * fRec0[2]) + (fConst96 * fRec0[1]))));
			fRec0[0] = ((std::fabs(fTempFTZ68) > 1.17549435e-38f) ? fTempFTZ68 : 0.0f);
			float fTempFTZ69 = (fTemp77 - (fConst299 * ((fConst300 * fRec73[2]) + (fConst104 * fRec73[1]))));
			fRec73[0] = ((std::fabs(fTempFTZ69) > 1.17549435e-38f) ? fTempFTZ69 : 0.0f);
			float fTempFTZ70 = (fTemp77 - (fConst306 * ((fConst307 * fRec74[2]) + (fConst308 * fRec74[1]))));
			fRec74[0] = ((std::fabs(fTempFTZ70) > 1.17549435e-38f) ? fTempFTZ70 : 0.0f);
			float fTempFTZ71 = (fTemp77 - (fConst314 * ((fConst315 * fRec75[2]) + (fConst316 * fRec75[1]))));
			fRec75[0] = ((std::fabs(fTempFTZ71) > 1.17549435e-38f) ? fTempFTZ71 : 0.0f);
			float fTempFTZ72 = (fTemp77 - (fConst322 * ((fConst323 * fRec76[2]) + (fConst324 * fRec76[1]))));
			fRec76[0] = ((std::fabs(fTempFTZ72) > 1.17549435e-38f) ? fTempFTZ72 : 0.0f);
			float fTempFTZ73 = (fTemp77 - (fConst330 * ((fConst331 * fRec77[2]) + (fConst332 * fRec77[1]))));
			fRec77[0] = ((std::fabs(fTempFTZ73) > 1.17549435e-38f) ? fTempFTZ73 : 0.0f);
			float fTempFTZ74 = (fTemp77 - (fConst338 * ((fConst339 * fRec78[2]) + (fConst340 * fRec78[1]))));
			fRec78[0] = ((std::fabs(fTempFTZ74) > 1.17549435e-38f) ? fTempFTZ74 : 0.0f);
			float fTemp78 = (fSlow0 * ((fConst5 * fRec0[2]) + (((fConst298 * fRec73[2]) + (((fConst305 * fRec74[2]) + (((fConst313 * fRec75[2]) + (((fConst321 * fRec76[2]) + (((fConst329 * fRec77[2]) + (((fConst337 * fRec78[2]) + ((fConst341 * fTemp76) + (fConst336 * fRec78[0]))) + (fConst328 * fRec77[0]))) + (fConst320 * fRec76[0]))) + (fConst312 * fRec75[0]))) + (fConst304 * fRec74[0]))) + (fConst297 * fRec73[0]))) + (fConst4 * fRec0[0]))));
