...
class FaustSarodDSP : public dsp {
 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow13 = ((2.0f * fSlow10) + 1.0f);
		float fSlow14 = (1.0f / fSlow13);
		float fSlow15 = (1.0f - (0.349999994f * fSlow10));
		float fSlow16 = float(fHslider7);
		float fSlow17 = (fConst31 * (fSlow16 * fSlow5));
		float fSlow18 = (fConst32 * std::max<float>(fSlow2, float(iSlow4)));
		float fSlow19 = (1350.0f * fSlow10);
		float fSlow20 = (0.25f * float(fHslider8));
		float fSlow21 = float(fHslider9);
		float fSlow22 = (fSlow21 + 1.0f);
		float fSlow23 = std::max<float>(40.0f, fSlow22);
		float fSlow24 = (675.0f * (fSlow10 / fSlow23));
		float fSlow25 = (fConst65 * fSlow16);
		float fSlow26 = std::max<float>(0.400000006f, (1.5f * (1.0f - (0.174999997f * fSlow10))));
		float fSlow27 = std::pow(0.00100000005f, (1.0f / (fSlow23 * fSlow26)));
		float fSlow28 = (fConst0 / fSlow23);
		int iSlow29 = int(fSlow28);
		float fSlow30 = float(iSlow29);
		float fSlow31 = (fSlow28 + (-0.499989986f - fSlow30));
		int iSlow32 = (std::min<int>(1024, std::max<int>(0, int(fSlow31))) + 1);
		float fSlow33 = (fSlow30 + std::floor(fSlow31));
		float fSlow34 = ((fSlow33 + (1.0f - fSlow28)) / (fSlow28 + (1.0f - fSlow33)));
		float fSlow35 = ((10.0f * fSlow10) + 1.0f);
		float fSlow36 = (1.0f / fSlow35);
		float fSlow37 = (fSlow10 + 1.0f);
		float fSlow38 = (1.0f / fSlow37);
		int iSlow39 = std::min<int>(16384, std::max<int>(0, iSlow29));
		float fSlow40 = (fConst15 * fSlow22);
		float fSlow41 = (fSlow21 + -1.0f);
		float fSlow42 = std::max<float>(40.0f, fSlow41);
		float fSlow43 = (675.0f * (fSlow10 / fSlow42));
		float fSlow44 = std::pow(0.00100000005f, (1.0f / (fSlow26 * fSlow42)));
		float fSlow45 = (fConst0 / fSlow42);
		...
		float fSlow53 = (fConst15 * fSlow41);
		float fSlow54 = float(fHslider10);
		float fSlow55 = (fSlow54 + 1.0f);
		float fSlow56 = std::max<float>(40.0f, fSlow55);
		float fSlow57 = (675.0f * (fSlow10 / fSlow56));
		float fSlow58 = std::pow(0.00100000005f, (1.0f / (fSlow26 * fSlow56)));
		float fSlow59 = (fConst0 / fSlow56);
		int iSlow60 = int(fSlow59);
		float fSlow61 = float(iSlow60);
		float fSlow62 = (fSlow59 + (-0.499989986f - fSlow61));
		int iSlow63 = (std::min<int>(1024, std::max<int>(0, int(fSlow62))) + 1);
		float fSlow64 = (fSlow61 + std::floor(fSlow62));
		float fSlow65 = ((fSlow64 + (1.0f - fSlow59)) / (fSlow59 + (1.0f - fSlow64)));
		int iSlow66 = std::min<int>(16384, std::max<int>(0, iSlow60));
		float fSlow67 = (fConst15 * fSlow55);
		float fSlow68 = (fSlow54 + -1.0f);
		float fSlow69 = std::max<float>(40.0f, fSlow68);
		float fSlow70 = std::pow(0.00100000005f, (1.0f / (fSlow26 * fSlow69)));
		float fSlow71 = (fConst0 / fSlow69);
		int iSlow72 = int(fSlow71);
		float fSlow73 = float(iSlow72);
		float fSlow74 = (fSlow71 + (-0.499989986f - fSlow73));
		int iSlow75 = (std::min<int>(1024, std::max<int>(0, int(fSlow74))) + 1);
		float fSlow76 = (fSlow73 + std::floor(fSlow74));
		float fSlow77 = ((fSlow76 + (1.0f - fSlow71)) / (fSlow71 + (1.0f - fSlow76)));
		int iSlow78 = std::min<int>(16384, std::max<int>(0, iSlow72));
		float fSlow79 = (675.0f * (fSlow10 / fSlow69));
		float fSlow80 = (fConst15 * fSlow68);
		float fSlow81 = std::max<float>((2.0f * fSlow3), 40.0f);
		float fSlow82 = std::max<float>(40.0f, fSlow81);
		float fSlow83 = (67.5f / fSlow82);
		float fSlow84 = (fConst78 * float(fHslider11));
		float fSlow85 = (fConst32 * fSlow2);
		float fSlow86 = (0.5f * fSlow2);
		float fSlow87 = std::pow(0.00100000005f, (0.254452914f / fSlow82));
		float fSlow88 = (fConst0 / fSlow82);
		int iSlow89 = int(fSlow88);
		float fSlow90 = float(iSlow89);
		float fSlow91 = (fSlow88 + (-0.499989986f - fSlow90));
		int iSlow92 = (std::min<int>(1024, std::max<int>(0, int(fSlow91))) + 1);
		float fSlow93 = (fSlow90 + std::floor(fSlow91));
		float fSlow94 = ((fSlow93 + (1.0f - fSlow88)) / (fSlow88 + (1.0f - fSlow93)));
		int iSlow95 = std::min<int>(16384, std::max<int>(0, iSlow89));
		float fSlow96 = (fConst15 * fSlow81);
		float fSlow97 = std::max<float>((1.5f * fSlow3), 40.0f);
		float fSlow98 = std::max<float>(40.0f, fSlow97);
		float fSlow99 = (67.5f / fSlow98);
		float fSlow100 = std::pow(0.00100000005f, (0.254452914f / fSlow98));
		float fSlow101 = (fConst0 / fSlow98);
		int iSlow102 = int(fSlow101);
		float fSlow103 = float(iSlow102);
		float fSlow104 = (fSlow101 + (-0.499989986f - fSlow103));
		int iSlow105 = (std::min<int>(1024, std::max<int>(0, int(fSlow104))) + 1);
		float fSlow106 = (fSlow103 + std::floor(fSlow104));
		float fSlow107 = ((fSlow106 + (1.0f - fSlow101)) / (fSlow101 + (1.0f - fSlow106)));
		int iSlow108 = std::min<int>(16384, std::max<int>(0, iSlow102));
		float fSlow109 = (fConst15 * fSlow97);
		float fSlow110 = std::max<float>(fSlow3, 40.0f);
		float fSlow111 = std::max<float>(40.0f, fSlow110);
		float fSlow112 = std::pow(0.00100000005f, (0.254452914f / fSlow111));
		float fSlow113 = (fConst0 / fSlow111);
		int iSlow114 = int(fSlow113);
		float fSlow115 = float(iSlow114);
		float fSlow116 = (fSlow113 + (-0.499989986f - fSlow115));
		int iSlow117 = (std::min<int>(1024, std::max<int>(0, int(fSlow116))) + 1);
		float fSlow118 = (fSlow115 + std::floor(fSlow116));
		float fSlow119 = ((fSlow118 + (1.0f - fSlow113)) / (fSlow113 + (1.0f - fSlow118)));
		int iSlow120 = std::min<int>(16384, std::max<int>(0, iSlow114));
		float fSlow121 = (67.5f / fSlow111);
		float fSlow122 = (fConst15 * fSlow110);
		float fSlow123 = (2.77722216f * fSlow0);
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			float fTemp2 = (fRec5[0] * ((fSlow8 * ftbl0FaustSarodDSPSIG0[int((65536.0f * fRec8[0]))]) + 1.0f));
			...
			float fThen1 = (fSlow12 * float(tanhf(float((fSlow11 * fTemp10)))));
			float fElse1 = (fSlow14 * float(tanhf(float((fSlow13 * fTemp10)))));
			float fTempFTZ4 = (fSlow18 + (fConst33 * fRec9[1]));
			...
			fVec5[(IOTA & 8191)] = ((((fTemp10 > 0.0f) ? fElse1 : fThen1) * std::pow(0.00100000005f, (1.0f / (fTemp3 * std::max<float>(0.400000006f, (fSlow15 * (4.0f - (1.70000005f * std::max<float>(0.0f, std::min<float>(1.0f, (0.00138888892f * (fRec5[0] + -80.0f)))))))))))) + (fSlow17 * ((fRec9[0] * (((fConst35 * fRec10[2]) + (fConst24 * fRec10[0])) + (fConst24 * fRec10[4]))) * std::max<float>(0.0f, std::min<float>((fConst47 * fTemp13), (1.0f - (fConst48 * (fTemp13 - fConst46))))))));
			...
			float fTemp16 = std::max<float>(1.0f, ((fSlow19 * ((fRec14[0] * ftbl0FaustSarodDSPSIG0[int((65536.0f * fRec15[0]))]) / fTemp3)) + 4.0f));
			...
			int iTemp20 = ((iSlow4 > iVec1[1]) | (iTemp0 & iSlow4));
			...
			float fTemp23 = (fSlow25 * (((((fConst67 * fRec18[2]) + (fConst58 * fRec18[0])) + (fConst58 * fRec18[4])) * std::max<float>(0.0f, std::min<float>((fConst47 * fTemp22), (1.0f - (fConst48 * (fTemp22 - fConst46)))))) * float(iTemp20)));
			float fTemp24 = fRec17[((IOTA - iSlow32) & 2047)];
			fVec7[0] = fTemp24;
			float fTempFTZ12 = (fVec7[1] - (fSlow34 * (fRec21[1] - fTemp24)));
			fRec21[0] = ((std::fabs(fTempFTZ12) > 1.17549435e-38f) ? fTempFTZ12 : 0.0f);
			float fTemp25 = ((0.00200000009f * fRec21[0]) + (0.998000026f * fRec21[1]));
			float fThen4 = (fSlow36 * float(tanhf(float((fSlow35 * fTemp25)))));
			float fElse4 = (fSlow38 * float(tanhf(float((fSlow37 * fTemp25)))));
			fVec8[(IOTA & 2047)] = (fTemp23 + (fSlow27 * ((fTemp25 > 0.0f) ? fElse4 : fThen4)));
			float fTempFTZ13 = fVec8[((IOTA - iSlow39) & 2047)];
			...
			float fTempFTZ15 = (fSlow40 + (fRec22[1] - std::floor((fSlow40 + fRec22[1]))));
			fRec22[0] = ((std::fabs(fTempFTZ15) > 1.17549435e-38f) ? fTempFTZ15 : 0.0f);
			float fTemp27 = std::max<float>(1.0f, ((fSlow24 * (fRec16[0] * ftbl0FaustSarodDSPSIG0[int((65536.0f * fRec22[0]))])) + 4.0f));
			float fTemp28 = (fTemp27 + 4.99999987e-06f);
			float fTemp29 = std::floor(fTemp28);
			int iTemp30 = int(fTemp28);
			float fTemp31 = fRec24[((IOTA - iSlow49) & 2047)];
			fVec9[0] = fTemp31;
			float fTempFTZ16 = (fVec9[1] - (fSlow51 * (fRec25[1] - fTemp31)));
			fRec25[0] = ((std::fabs(fTempFTZ16) > 1.17549435e-38f) ? fTempFTZ16 : 0.0f);
			float fTemp32 = ((0.00200000009f * fRec25[0]) + (0.998000026f * fRec25[1]));
			float fThen5 = (fSlow36 * float(tanhf(float((fSlow35 * fTemp32)))));
			float fElse5 = (fSlow38 * float(tanhf(float((fSlow37 * fTemp32)))));
			fVec10[(IOTA & 2047)] = (fTemp23 + (fSlow44 * ((fTemp32 > 0.0f) ? fElse5 : fThen5)));
			float fTempFTZ17 = fVec10[((IOTA - iSlow52) & 2047)];
			...
			float fTempFTZ19 = (fSlow53 + (fRec26[1] - std::floor((fSlow53 + fRec26[1]))));
			fRec26[0] = ((std::fabs(fTempFTZ19) > 1.17549435e-38f) ? fTempFTZ19 : 0.0f);
			float fTemp34 = std::max<float>(1.0f, ((fSlow43 * (fRec23[0] * ftbl0FaustSarodDSPSIG0[int((65536.0f * fRec26[0]))])) + 4.0f));
			float fTemp35 = (fTemp34 + 4.99999987e-06f);
			float fTemp36 = std::floor(fTemp35);
			int iTemp37 = int(fTemp35);
			float fTemp38 = fRec28[((IOTA - iSlow63) & 2047)];
			fVec11[0] = fTemp38;
			float fTempFTZ20 = (fVec11[1] - (fSlow65 * (fRec29[1] - fTemp38)));
			fRec29[0] = ((std::fabs(fTempFTZ20) > 1.17549435e-38f) ? fTempFTZ20 : 0.0f);
			float fTemp39 = ((0.00200000009f * fRec29[0]) + (0.998000026f * fRec29[1]));
			float fThen6 = (fSlow36 * float(tanhf(float((fSlow35 * fTemp39)))));
			float fElse6 = (fSlow38 * float(tanhf(float((fSlow37 * fTemp39)))));
			fVec12[(IOTA & 2047)] = (fTemp23 + (fSlow58 * ((fTemp39 > 0.0f) ? fElse6 : fThen6)));
			float fTempFTZ21 = fVec12[((IOTA - iSlow66) & 2047)];
			...
			float fTempFTZ23 = (fSlow67 + (fRec30[1] - std::floor((fSlow67 + fRec30[1]))));
			fRec30[0] = ((std::fabs(fTempFTZ23) > 1.17549435e-38f) ? fTempFTZ23 : 0.0f);
			float fTemp41 = std::max<float>(1.0f, ((fSlow57 * (fRec27[0] * ftbl0FaustSarodDSPSIG0[int((65536.0f * fRec30[0]))])) + 4.0f));
			float fTemp42 = (fTemp41 + 4.99999987e-06f);
			float fTemp43 = std::floor(fTemp42);
			int iTemp44 = int(fTemp42);
			float fTemp45 = fRec31[((IOTA - iSlow75) & 2047)];
			fVec13[0] = fTemp45;
			float fTempFTZ24 = (fVec13[1] - (fSlow77 * (fRec32[1] - fTemp45)));
			fRec32[0] = ((std::fabs(fTempFTZ24) > 1.17549435e-38f) ? fTempFTZ24 : 0.0f);
			float fTemp46 = ((0.00200000009f * fRec32[0]) + (0.998000026f * fRec32[1]));
			float fThen7 = (fSlow36 * float(tanhf(float((fSlow35 * fTemp46)))));
			float fElse7 = (fSlow38 * float(tanhf(float((fSlow37 * fTemp46)))));
			fVec14[(IOTA & 2047)] = ((fSlow70 * ((fTemp46 > 0.0f) ? fElse7 : fThen7)) + fTemp23);
			float fTempFTZ25 = fVec14[((IOTA - iSlow78) & 2047)];
			...
			float fTempFTZ27 = (fSlow80 + (fRec34[1] - std::floor((fSlow80 + fRec34[1]))));
			fRec34[0] = ((std::fabs(fTempFTZ27) > 1.17549435e-38f) ? fTempFTZ27 : 0.0f);
			float fTemp48 = std::max<float>(1.0f, ((fSlow79 * (fRec33[0] * ftbl0FaustSarodDSPSIG0[int((65536.0f * fRec34[0]))])) + 4.0f));
			float fTemp49 = (fTemp48 + 4.99999987e-06f);
			int iTemp50 = int(fTemp49);
			float fTemp51 = std::floor(fTemp49);
			float fTemp52 = float(tanhf(float((2.0f * (((fRec3[((IOTA - std::min<int>(1024, int(std::max<int>(0, int(iTemp18))))) & 2047)] * (0.0f - (fTemp16 + (-1.0f - fTemp19)))) + ((fTemp16 - fTemp19) * fRec3[((IOTA - std::min<int>(1024, int(std::max<int>(0, int((iTemp18 + 1)))))) & 2047)])) + (fSlow20 * (((fTemp27 - fTemp29) * fRec17[((IOTA - std::min<int>(1024, int(std::max<int>(0, int((iTemp30 + 1)))))) & 2047)]) + ((((fTemp34 - fTemp36) * fRec24[((IOTA - std::min<int>(1024, int(std::max<int>(0, int((iTemp37 + 1)))))) & 2047)]) + ((((fTemp41 - fTemp43) * fRec28[((IOTA - std::min<int>(1024, int(std::max<int>(0, int((iTemp44 + 1)))))) & 2047)]) + (((fRec31[((IOTA - std::min<int>(1024, int(std::max<int>(0, int(iTemp50))))) & 2047)] * (0.0f - (fTemp48 + (-1.0f - fTemp51)))) + ((fTemp48 - fTemp51) * fRec31[((IOTA - std::min<int>(1024, int(std::max<int>(0, int((iTemp50 + 1)))))) & 2047)])) + (fRec28[((IOTA - std::min<int>(1024, int(std::max<int>(0, int(iTemp44))))) & 2047)] * (0.0f - (fTemp41 + (-1.0f - fTemp43)))))) + (fRec24[((IOTA - std::min<int>(1024, int(std::max<int>(0, int(iTemp37))))) & 2047)] * (0.0f - (fTemp34 + (-1.0f - fTemp36)))))) + (fRec17[((IOTA - std::min<int>(1024, int(std::max<int>(0, int(iTemp30))))) & 2047)] * (0.0f - (fTemp27 + (-1.0f - fTemp29))))))))))));
			float fTempFTZ28 = (fSlow85 + (fConst33 * fRec37[1]));
			fRec37[0] = ((std::fabs(fTempFTZ28) > 1.17549435e-38f) ? fTempFTZ28 : 0.0f);
			float fTempFTZ29 = ((fSlow86 * fTemp52) - (fConst78 * ((fConst79 * fRec38[2]) + (fConst80 * fRec38[1]))));
			fRec38[0] = ((std::fabs(fTempFTZ29) > 1.17549435e-38f) ? fTempFTZ29 : 0.0f);
			float fTemp53 = (fSlow84 * (fRec37[0] * (fRec38[2] + (fRec38[0] + (2.0f * fRec38[1])))));
			float fTemp54 = fRec36[((IOTA - iSlow92) & 2047)];
			fVec15[0] = fTemp54;
			float fTempFTZ30 = (fVec15[1] - (fSlow94 * (fRec39[1] - fTemp54)));
			...
			fVec16[(IOTA & 2047)] = (fTemp53 + (fSlow87 * ((fTemp55 > 0.0f) ? fElse8 : fThen8)));
			float fTempFTZ31 = fVec16[((IOTA - iSlow95) & 2047)];
			...
			float fTempFTZ33 = (fSlow96 + (fRec40[1] - std::floor((fSlow96 + fRec40[1]))));
			fRec40[0] = ((std::fabs(fTempFTZ33) > 1.17549435e-38f) ? fTempFTZ33 : 0.0f);
			float fTemp57 = std::max<float>(1.0f, ((fSlow83 * (fRec35[0] * ftbl0FaustSarodDSPSIG0[int((65536.0f * fRec40[0]))])) + 4.0f));
			float fTemp58 = (fTemp57 + 4.99999987e-06f);
			float fTemp59 = std::floor(fTemp58);
			int iTemp60 = int(fTemp58);
			float fTemp61 = fRec42[((IOTA - iSlow105) & 2047)];
			fVec17[0] = fTemp61;
			float fTempFTZ34 = (fVec17[1] - (fSlow107 * (fRec43[1] - fTemp61)));
			...
			fVec18[(IOTA & 2047)] = (fTemp53 + (fSlow100 * ((fTemp62 > 0.0f) ? fElse9 : fThen9)));
			float fTempFTZ35 = fVec18[((IOTA - iSlow108) & 2047)];
			...
			float fTempFTZ37 = (fSlow109 + (fRec44[1] - std::floor((fSlow109 + fRec44[1]))));
			fRec44[0] = ((std::fabs(fTempFTZ37) > 1.17549435e-38f) ? fTempFTZ37 : 0.0f);
			float fTemp64 = std::max<float>(1.0f, ((fSlow99 * (fRec41[0] * ftbl0FaustSarodDSPSIG0[int((65536.0f * fRec44[0]))])) + 4.0f));
			float fTemp65 = (fTemp64 + 4.99999987e-06f);
			float fTemp66 = std::floor(fTemp65);
			int iTemp67 = int(fTemp65);
			float fTemp68 = fRec45[((IOTA - iSlow117) & 2047)];
			fVec19[0] = fTemp68;
			float fTempFTZ38 = (fVec19[1] - (fSlow119 * (fRec46[1] - fTemp68)));
			...
			fVec20[(IOTA & 4095)] = ((fSlow112 * ((fTemp69 > 0.0f) ? fElse10 : fThen10)) + fTemp53);
			float fTempFTZ39 = fVec20[((IOTA - iSlow120) & 4095)];
			...
			float fTempFTZ41 = (fSlow122 + (fRec48[1] - std::floor((fSlow122 + fRec48[1]))));
			fRec48[0] = ((std::fabs(fTempFTZ41) > 1.17549435e-38f) ? fTempFTZ41 : 0.0f);
			float fTemp71 = std::max<float>(1.0f, ((fSlow121 * (fRec47[0] * ftbl0FaustSarodDSPSIG0[int((65536.0f * fRec48[0]))])) + 4.0f));
			...
			float fTemp78 = ((fConst5 * fRec0[2]) + (((fConst300 * fRec73[2]) + (((fConst307 * fRec74[2]) + (((fConst315 * fRec75[2]) + (((fConst323 * fRec76[2]) + (((fConst331 * fRec77[2]) + (((fConst339 * fRec78[2]) + ((fConst343 * fTemp76) + (fConst338 * fRec78[0]))) + (fConst330 * fRec77[0]))) + (fConst322 * fRec76[0]))) + (fConst314 * fRec75[0]))) + (fConst306 * fRec74[0]))) + (fConst299 * fRec73[0]))) + (fConst4 * fRec0[0])));
			float fTemp79 = (fSlow1 * fTemp78);
			float fThen11 = (0.899999976f * float(tanhf(float((fSlow123 * fTemp78)))));
			float fTemp80 = ((std::fabs(fTemp79) < 0.899999976f) ? fTemp79 : fThen11);
			output0[i0] = FAUSTFLOAT(fTemp80);
			output1[i0] = FAUSTFLOAT(fTemp80);
			fVec0[1] = fVec0[0];
			iVec1[1] = iVec1[0];
			fRec6[1] = fRec6[0];
			fRec5[1] = fRec5[0];
