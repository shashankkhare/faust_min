...
#ifndef  __FaustTrack_fxDSP_H__
#define  __FaustTrack_fxDSP_H__
...
static float FaustTrack_fxDSP_faustpower2_f(float value) {
	return (value * value);
}

#ifndef FAUSTCLASS 
#define FAUSTCLASS FaustTrack_fxDSP
#endif
...
class FaustTrack_fxDSP : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		float fConst11 = FaustTrack_fxDSP_faustpower2_f(fConst8);
		...
		float fConst22 = FaustTrack_fxDSP_faustpower2_f(fConst1);
	...
	virtual FaustTrack_fxDSP* clone() {
		return new FaustTrack_fxDSP();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow5 = (2.0f * (1.0f - (1.0f / FaustTrack_fxDSP_faustpower2_f(fSlow4))));
		...
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			fVec0[0] = fTemp1;
			fRec5[0] = ((fConst14 * fVec0[1]) - (fConst15 * ((fConst16 * fRec5[1]) - (fConst9 * fTemp1))));
			fRec4[0] = (fRec5[0] - (fConst10 * ((fConst17 * fRec4[2]) + (fConst18 * fRec4[1]))));
			fRec7[0] = (0.0f - (fConst15 * ((fConst16 * fRec7[1]) - (fTemp1 + fVec0[1]))));
			fRec6[0] = (fRec7[0] - (fConst10 * ((fConst17 * fRec6[2]) + (fConst18 * fRec6[1]))));
			float fTemp2 = (fSlow5 * fRec3[1]);
			fRec3[0] = ((fConst10 * ((((fConst12 * fRec4[0]) + (fConst19 * fRec4[1])) + (fConst12 * fRec4[2])) + (fSlow6 * (fRec6[2] + (fRec6[0] + (2.0f * fRec6[1])))))) - (((fRec3[2] * fSlow14) + fTemp2) / fSlow15));
			float fTemp3 = (((fTemp2 + (fRec3[0] * fSlow17)) + (fRec3[2] * fSlow18)) / fSlow15);
			fVec1[0] = fTemp3;
			fRec2[0] = (0.0f - (fConst5 * ((fConst6 * fRec2[1]) - (fTemp3 + fVec1[1]))));
			fRec1[0] = (fRec2[0] - (fConst3 * ((fConst21 * fRec1[2]) + (fConst24 * fRec1[1]))));
			fRec9[0] = ((fConst25 * fVec1[1]) - (fConst5 * ((fConst6 * fRec9[1]) - (fConst2 * fTemp3))));
			fRec8[0] = (fRec9[0] - (fConst3 * ((fConst21 * fRec8[2]) + (fConst24 * fRec8[1]))));
			...
			fRec0[(IOTA & 262143)] = (fTemp5 + (fSlow20 * fRec0[((IOTA - iSlow21) & 262143)]));
			...
			fVec2[0] = fTemp7;
			fRec15[0] = ((fConst14 * fVec2[1]) - (fConst15 * ((fConst16 * fRec15[1]) - (fConst9 * fTemp7))));
			fRec14[0] = (fRec15[0] - (fConst10 * ((fConst17 * fRec14[2]) + (fConst18 * fRec14[1]))));
			fRec17[0] = (0.0f - (fConst15 * ((fConst16 * fRec17[1]) - (fTemp7 + fVec2[1]))));
			fRec16[0] = (fRec17[0] - (fConst10 * ((fConst17 * fRec16[2]) + (fConst18 * fRec16[1]))));
			float fTemp8 = (fSlow5 * fRec13[1]);
			fRec13[0] = ((fConst10 * ((((fConst12 * fRec14[0]) + (fConst19 * fRec14[1])) + (fConst12 * fRec14[2])) + (fSlow6 * (fRec16[2] + (fRec16[0] + (2.0f * fRec16[1])))))) - (((fSlow14 * fRec13[2]) + fTemp8) / fSlow15));
			float fTemp9 = (((fTemp8 + (fRec13[0] * fSlow17)) + (fSlow18 * fRec13[2])) / fSlow15);
			fVec3[0] = fTemp9;
			fRec12[0] = (0.0f - (fConst5 * ((fConst6 * fRec12[1]) - (fTemp9 + fVec3[1]))));
			fRec11[0] = (fRec12[0] - (fConst3 * ((fConst21 * fRec11[2]) + (fConst24 * fRec11[1]))));
			fRec19[0] = ((fConst25 * fVec3[1]) - (fConst5 * ((fConst6 * fRec19[1]) - (fConst2 * fTemp9))));
			fRec18[0] = (fRec19[0] - (fConst3 * ((fConst21 * fRec18[2]) + (fConst24 * fRec18[1]))));
			...
			fRec10[(IOTA & 262143)] = (fTemp11 + (fSlow20 * fRec10[((IOTA - iSlow21) & 262143)]));
