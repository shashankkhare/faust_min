...
class FaustCongaDSP : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst6 = (9.99026489f / fConst0);
		fConst7 = (2.85714293f / fConst0);
		fConst8 = (13.4460163f / fConst0);
		fConst9 = (4.0f / fConst0);
		fConst10 = (14.4513264f / fConst0);
		fConst11 = (5.0f / fConst0);
		fConst12 = (16.6504402f / fConst0);
		fConst13 = (6.66666651f / fConst0);
		fConst14 = (18.3469009f / fConst0);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow4 = (35.0f * (float(fHslider0) / fSlow3));
		...
		float fSlow8 = std::tan((fConst2 * ((500.0f * fSlow7) + 40.0f)));
		...
		float fSlow15 = std::tan((fConst2 * ((15000.0f * fSlow7) + 500.0f)));
		...
		float fSlow25 = std::max<float>(1.0f, (fConst3 * (iSlow23 ? 1.29999995f : fThen3)));
		float fSlow26 = std::cos((fConst4 * fSlow0));
		float fThen5 = (iSlow24 ? 0.600000024f : 1.0f);
		float fSlow27 = (iSlow23 ? 0.150000006f : fThen5);
		float fSlow28 = std::pow(0.00100000005f, (fConst5 / fSlow27));
		float fSlow29 = (0.0f - (2.0f * fSlow28));
		float fSlow30 = FaustCongaDSP_faustpower2_f(fSlow28);
		float fSlow31 = std::cos((fConst6 * fSlow0));
		float fSlow32 = std::pow(0.00100000005f, (fConst7 / fSlow27));
		float fSlow33 = (0.0f - (2.0f * fSlow32));
		float fSlow34 = FaustCongaDSP_faustpower2_f(fSlow32);
		float fSlow35 = std::cos((fConst8 * fSlow0));
		float fSlow36 = std::pow(0.00100000005f, (fConst9 / fSlow27));
		float fSlow37 = (0.0f - (2.0f * fSlow36));
		float fSlow38 = FaustCongaDSP_faustpower2_f(fSlow36);
		float fSlow39 = std::cos((fConst10 * fSlow0));
		float fSlow40 = std::pow(0.00100000005f, (fConst11 / fSlow27));
		float fSlow41 = (0.0f - (2.0f * fSlow40));
		float fSlow42 = FaustCongaDSP_faustpower2_f(fSlow40);
		float fSlow43 = std::cos((fConst12 * fSlow0));
		float fSlow44 = std::pow(0.00100000005f, (fConst13 / fSlow27));
		float fSlow45 = (0.0f - (2.0f * fSlow44));
		float fSlow46 = FaustCongaDSP_faustpower2_f(fSlow44);
		float fSlow47 = std::cos((fConst14 * fSlow0));
		float fSlow48 = std::pow(0.00100000005f, (fConst15 / fSlow27));
		float fSlow49 = (0.0f - (2.0f * fSlow48));
		float fSlow50 = FaustCongaDSP_faustpower2_f(fSlow48);
		float fSlow51 = (1.0f / fSlow3);
		float fSlow52 = (((fSlow2 + -1.41421354f) / fSlow1) + 1.0f);
		float fSlow53 = (2.0f * (1.0f - (1.0f / FaustCongaDSP_faustpower2_f(fSlow1))));
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			iRec4[0] = ((1103515245 * iRec4[1]) + 12345);
			float fTempFTZ0 = ((4.65661287e-10f * float(iRec4[0])) - (((fRec3[2] * fSlow10) + (2.0f * (fRec3[1] * fSlow12))) / fSlow13));
			fRec3[0] = ((std::fabs(fTempFTZ0) > 1.17549435e-38f) ? fTempFTZ0 : 0.0f);
			float fTempFTZ1 = (((((fRec3[1] * fSlow14) + (fRec3[0] / fSlow11)) + (fRec3[2] / fSlow11)) / fSlow13) - (((fRec2[2] * fSlow17) + (2.0f * (fRec2[1] * fSlow18))) / fSlow19));
			...
			float fTemp1 = (float(iRec5[0]) / fSlow25);
			float fTemp2 = (fSlow5 * (((fRec2[2] + (fRec2[0] + (2.0f * fRec2[1]))) * std::max<float>(0.0f, std::min<float>(fTemp1, (2.0f - fTemp1)))) / fSlow19));
			float fTempFTZ2 = (fTemp2 - ((fSlow26 * (fRec1[1] * fSlow29)) + (fSlow30 * fRec1[2])));
			fRec1[0] = ((std::fabs(fTempFTZ2) > 1.17549435e-38f) ? fTempFTZ2 : 0.0f);
			float fTempFTZ3 = (fTemp2 - ((fSlow31 * (fRec6[1] * fSlow33)) + (fSlow34 * fRec6[2])));
			fRec6[0] = ((std::fabs(fTempFTZ3) > 1.17549435e-38f) ? fTempFTZ3 : 0.0f);
			float fTempFTZ4 = (fTemp2 - ((fSlow35 * (fRec7[1] * fSlow37)) + (fSlow38 * fRec7[2])));
			fRec7[0] = ((std::fabs(fTempFTZ4) > 1.17549435e-38f) ? fTempFTZ4 : 0.0f);
			float fTempFTZ5 = (fTemp2 - ((fSlow39 * (fRec8[1] * fSlow41)) + (fSlow42 * fRec8[2])));
			fRec8[0] = ((std::fabs(fTempFTZ5) > 1.17549435e-38f) ? fTempFTZ5 : 0.0f);
			float fTempFTZ6 = (fTemp2 - ((fSlow43 * (fRec9[1] * fSlow45)) + (fSlow46 * fRec9[2])));
			fRec9[0] = ((std::fabs(fTempFTZ6) > 1.17549435e-38f) ? fTempFTZ6 : 0.0f);
			float fTempFTZ7 = (fTemp2 - ((fSlow47 * (fRec10[1] * fSlow49)) + (fSlow50 * fRec10[2])));
			fRec10[0] = ((std::fabs(fTempFTZ7) > 1.17549435e-38f) ? fTempFTZ7 : 0.0f);
			float fTempFTZ8 = ((0.166666672f * ((((((fRec1[0] + (0.25f * (fRec6[0] - fRec6[2]))) + (0.111111112f * (fRec7[0] - fRec7[2]))) + (0.0625f * (fRec8[0] - fRec8[2]))) + (0.0399999991f * (fRec9[0] - fRec9[2]))) + (0.027777778f * (fRec10[0] - fRec10[2]))) - fRec1[2])) - (fSlow51 * ((fSlow52 * fRec0[2]) + (fSlow53 * fRec0[1]))));
			fRec0[0] = ((std::fabs(fTempFTZ8) > 1.17549435e-38f) ? fTempFTZ8 : 0.0f);
			output0[i0] = FAUSTFLOAT(float(tanhf(float((fSlow4 * (fRec0[2] + (fRec0[0] + (2.0f * fRec0[1]))))))));
			iRec4[1] = iRec4[0];
			fRec3[2] = fRec3[1];
			fRec3[1] = fRec3[0];
			fRec2[2] = fRec2[1];
