...
class FaustPianoDSP : public dsp {
 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow10 = (1.0f / std::tan((fConst6 * (6000.0f - (0.800000012f * fSlow5)))));
		...
		float fSlow23 = std::max<float>(20.0f, fSlow5);
		float fThen1 = std::max<float>(0.5f, (1.0f - (17.2999992f / fSlow23)));
		float fElse1 = std::max<float>(0.985000014f, (1.0f - (1.0f / fSlow23)));
		float fSlow24 = (((fSlow4 > 0.0f) | (float(fHslider5) > 0.0f)) ? fElse1 : fThen1);
		...
		float fSlow39 = (fConst41 * float(fHslider6));
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			float fTemp1 = ((fSlow17 * fRec2[((IOTA - iSlow19) & 8191)]) + (fSlow20 * fRec2[((IOTA - iSlow21) & 8191)]));
			float fTempFTZ2 = ((fSlow22 * fTemp1) - (fSlow14 * fRec7[1]));
			fRec7[0] = ((std::fabs(fTempFTZ2) > 1.17549435e-38f) ? fTempFTZ2 : 0.0f);
			float fTemp2 = ((fSlow14 * fTemp1) + (fSlow22 * fRec7[1]));
			fVec2[0] = fTemp2;
			float fTempFTZ3 = (0.0f - (fSlow11 * ((fSlow12 * fRec6[1]) - (fTemp2 + fVec2[1]))));
			fRec6[0] = ((std::fabs(fTempFTZ3) > 1.17549435e-38f) ? fTempFTZ3 : 0.0f);
			float fTempFTZ4 = (fRec3[0] + (fRec6[0] * fSlow24));
			...
			float fTempFTZ5 = ((fSlow22 * fTemp4) - (fSlow14 * fRec10[1]));
			fRec10[0] = ((std::fabs(fTempFTZ5) > 1.17549435e-38f) ? fTempFTZ5 : 0.0f);
			float fTemp5 = ((fSlow14 * fTemp4) + (fSlow22 * fRec10[1]));
			fVec3[0] = fTemp5;
			float fTempFTZ6 = (0.0f - (fSlow11 * ((fSlow12 * fRec9[1]) - (fTemp5 + fVec3[1]))));
			fRec9[0] = ((std::fabs(fTempFTZ6) > 1.17549435e-38f) ? fTempFTZ6 : 0.0f);
			float fTempFTZ7 = (fRec3[0] + (fRec9[0] * fSlow24));
			...
			float fTempFTZ8 = ((fSlow22 * fTemp6) - (fSlow14 * fRec13[1]));
			fRec13[0] = ((std::fabs(fTempFTZ8) > 1.17549435e-38f) ? fTempFTZ8 : 0.0f);
			float fTemp7 = ((fSlow14 * fTemp6) + (fSlow22 * fRec13[1]));
			fVec4[0] = fTemp7;
			float fTempFTZ9 = (0.0f - (fSlow11 * ((fSlow12 * fRec12[1]) - (fTemp7 + fVec4[1]))));
			fRec12[0] = ((std::fabs(fTempFTZ9) > 1.17549435e-38f) ? fTempFTZ9 : 0.0f);
			float fTempFTZ10 = (fRec3[0] + (fRec12[0] * fSlow24));
