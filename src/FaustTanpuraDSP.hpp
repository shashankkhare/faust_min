...
class FaustTanpuraDSP : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		float fConst6 = (1.0f / std::tan((2513.27417f / fConst0)));
		fConst7 = (1.0f / (fConst6 + 1.0f));
		fConst8 = (1.0f - fConst6);
		float fConst9 = std::tan((6283.18555f / fConst0));
		float fConst10 = (1.0f / fConst9);
		fConst11 = (1.0f / (((fConst10 + 1.41421354f) / fConst9) + 1.0f));
		fConst12 = (((fConst10 + -1.41421354f) / fConst9) + 1.0f);
		fConst13 = (2.0f * (1.0f - (1.0f / FaustTanpuraDSP_faustpower2_f(fConst9))));
		fConst14 = std::exp((0.0f - (33.3333321f / fConst0)));
		fConst15 = (1.0f - fConst14);
		fConst16 = (1.0f / fConst0);
		fConst17 = (1.0f / fConst3);
		fConst18 = (((fConst2 + -0.285714298f) / fConst1) + 1.0f);
		fConst19 = (2.0f * (1.0f - (1.0f / FaustTanpuraDSP_faustpower2_f(fConst1))));
		float fConst20 = std::tan((4555.30957f / fConst0));
		float fConst21 = (1.0f / fConst20);
		float fConst22 = (((fConst21 + 0.333333343f) / fConst20) + 1.0f);
		fConst23 = (0.0799999982f / (fConst20 * fConst22));
		fConst24 = (0.0f - fConst23);
		fConst25 = (1.0f / fConst22);
		fConst26 = (((fConst21 + -0.333333343f) / fConst20) + 1.0f);
		fConst27 = (2.0f * (1.0f - (1.0f / FaustTanpuraDSP_faustpower2_f(fConst20))));
		float fConst28 = std::tan((2261.94678f / fConst0));
		float fConst29 = (1.0f / fConst28);
		float fConst30 = (((fConst29 + 0.200000003f) / fConst28) + 1.0f);
		float fConst31 = (fConst28 * fConst30);
		fConst32 = (1.0f / fConst31);
		fConst33 = (1.0f / fConst30);
		fConst34 = (((fConst29 + -0.200000003f) / fConst28) + 1.0f);
		fConst35 = (2.0f * (1.0f - (1.0f / FaustTanpuraDSP_faustpower2_f(fConst28))));
		fConst36 = (0.0f - (0.150000006f / fConst31));
		float fConst37 = std::tan((785.398193f / fConst0));
		float fConst38 = (1.0f / fConst37);
		float fConst39 = (((fConst38 + 0.333333343f) / fConst37) + 1.0f);
		fConst40 = (0.349999994f / (fConst37 * fConst39));
		fConst41 = (0.0f - fConst40);
		fConst42 = (1.0f / fConst39);
		fConst43 = (((fConst38 + -0.333333343f) / fConst37) + 1.0f);
		fConst44 = (2.0f * (1.0f - (1.0f / FaustTanpuraDSP_faustpower2_f(fConst37))));
		float fConst45 = std::tan((329.867218f / fConst0));
		float fConst46 = (1.0f / fConst45);
		float fConst47 = (((fConst46 + 0.333333343f) / fConst45) + 1.0f);
		fConst48 = (0.449999988f / (fConst45 * fConst47));
		fConst49 = (0.0f - fConst48);
		fConst50 = (1.0f / fConst47);
		fConst51 = (((fConst46 + -0.333333343f) / fConst45) + 1.0f);
		fConst52 = (2.0f * (1.0f - (1.0f / FaustTanpuraDSP_faustpower2_f(fConst45))));
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow17 = (((fSlow16 * float(fHslider4)) * float(fHslider5)) * float(fHslider6));
		...
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			float fTempFTZ1 = ((4.65661287e-10f * float(iRec6[0])) - (fConst11 * ((fConst12 * fRec5[2]) + (fConst13 * fRec5[1]))));
			fRec5[0] = ((std::fabs(fTempFTZ1) > 1.17549435e-38f) ? fTempFTZ1 : 0.0f);
			float fTemp2 = (fRec5[2] + (fRec5[0] + (2.0f * fRec5[1])));
			fVec2[0] = fTemp2;
			float fTempFTZ2 = (0.0f - (fConst7 * ((fConst8 * fRec4[1]) - (fConst11 * (fTemp2 + fVec2[1])))));
			fRec4[0] = ((std::fabs(fTempFTZ2) > 1.17549435e-38f) ? fTempFTZ2 : 0.0f);
			int iTemp3 = ((fSlow16 - fVec1[1]) > 0.0f);
			iVec3[0] = iTemp3;
			iRec7[0] = ((iTemp3 > iVec3[1]) + ((iTemp3 <= iVec3[1]) * (iRec7[1] + (iRec7[1] > 0))));
			float fTemp4 = (fSlow18 * float(iRec7[0]));
			fVec4[(IOTA & 2047)] = ((fSlow4 * ((fTemp1 > 0.0f) ? fElse0 : fThen0)) + (fSlow17 * (fRec4[0] * std::max<float>(0.0f, std::min<float>(fTemp4, (2.0f - fTemp4))))));
			float fTempFTZ3 = fVec4[((IOTA - iSlow19) & 2047)];
			fRec2[(IOTA & 2047)] = ((std::fabs(fTempFTZ3) > 1.17549435e-38f) ? fTempFTZ3 : 0.0f);
			float fTemp5 = std::fabs(fRec2[((IOTA - 0) & 2047)]);
			float fTempFTZ4 = std::max<float>(fTemp5, ((fConst14 * fRec8[1]) + (fConst15 * fTemp5)));
			fRec8[0] = ((std::fabs(fTempFTZ4) > 1.17549435e-38f) ? fTempFTZ4 : 0.0f);
			float fTempFTZ5 = (fSlow21 + (fRec10[1] - std::floor((fSlow21 + fRec10[1]))));
			fRec10[0] = ((std::fabs(fTempFTZ5) > 1.17549435e-38f) ? fTempFTZ5 : 0.0f);
			float fTemp6 = std::max<float>(1.0f, ((fSlow20 * (fRec8[0] * ftbl0FaustTanpuraDSPSIG0[int((65536.0f * fRec10[0]))])) + 4.0f));
			float fTemp7 = (fTemp6 + 4.99999987e-06f);
			int iTemp8 = int(fTemp7);
			float fTemp9 = std::floor(fTemp7);
			float fTemp10 = ((fRec2[((IOTA - std::min<int>(1024, int(std::max<int>(0, int(iTemp8))))) & 2047)] * (0.0f - (fTemp6 + (-1.0f - fTemp9)))) + ((fTemp6 - fTemp9) * fRec2[((IOTA - std::min<int>(1024, int(std::max<int>(0, int((iTemp8 + 1)))))) & 2047)]));
			float fTempFTZ6 = (fTemp10 - (fConst17 * ((fConst18 * fRec1[2]) + (fConst19 * fRec1[1]))));
			fRec1[0] = ((std::fabs(fTempFTZ6) > 1.17549435e-38f) ? fTempFTZ6 : 0.0f);
			float fTemp11 = (fConst5 * fRec1[2]);
			float fTemp12 = (fConst4 * fRec1[0]);
			float fTempFTZ7 = (fTemp10 - (fConst25 * ((fConst26 * fRec11[2]) + (fConst27 * fRec11[1]))));
			fRec11[0] = ((std::fabs(fTempFTZ7) > 1.17549435e-38f) ? fTempFTZ7 : 0.0f);
			float fTemp13 = (fConst24 * fRec11[2]);
			float fTemp14 = (fConst23 * fRec11[0]);
			float fTempFTZ8 = (fTemp10 - (fConst33 * ((fConst34 * fRec12[2]) + (fConst35 * fRec12[1]))));
			fRec12[0] = ((std::fabs(fTempFTZ8) > 1.17549435e-38f) ? fTempFTZ8 : 0.0f);
			float fTemp15 = (0.150000006f * (fTemp10 + (fConst32 * fRec12[0])));
			float fTemp16 = (fConst36 * fRec12[2]);
			float fTempFTZ9 = (fTemp10 - (fConst42 * ((fConst43 * fRec13[2]) + (fConst44 * fRec13[1]))));
			fRec13[0] = ((std::fabs(fTempFTZ9) > 1.17549435e-38f) ? fTempFTZ9 : 0.0f);
			float fTemp17 = (fConst41 * fRec13[2]);
			float fTemp18 = (fConst40 * fRec13[0]);
			float fTempFTZ10 = (fTemp10 - (fConst50 * ((fConst51 * fRec14[2]) + (fConst52 * fRec14[1]))));
			fRec14[0] = ((std::fabs(fTempFTZ10) > 1.17549435e-38f) ? fTempFTZ10 : 0.0f);
			float fTemp19 = (fConst49 * fRec14[2]);
			float fTemp20 = (fConst48 * fRec14[0]);
			fVec6[0] = (fTemp11 + ((fTemp13 + ((fTemp15 + (fTemp16 + (fTemp17 + ((fTemp20 + fTemp19) + fTemp18)))) + fTemp14)) + fTemp12));
			float fTempFTZ11 = ((fTemp11 + (fTemp12 + (fTemp13 + (fTemp14 + (fTemp15 + (fTemp16 + (fTemp17 + (fTemp18 + (fTemp19 + ((0.995000005f * fRec0[1]) + fTemp20)))))))))) - fVec6[1]);
