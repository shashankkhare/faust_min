...
class FaustTanpuraDSP : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst28 = (0.150000006f / (fConst25 * fConst27));
		...
		float fConst33 = std::tan((785.398193f / fConst0));
		float fConst34 = (1.0f / fConst33);
		float fConst35 = (((fConst34 + 0.333333343f) / fConst33) + 1.0f);
		fConst36 = (0.349999994f / (fConst33 * fConst35));
		...
		float fConst41 = std::tan((329.867218f / fConst0));
		float fConst42 = (1.0f / fConst41);
		float fConst43 = (((fConst42 + 0.333333343f) / fConst41) + 1.0f);
		fConst44 = (0.449999988f / (fConst41 * fConst43));
		fConst45 = (0.0f - fConst44);
		fConst46 = (1.0f / fConst43);
		fConst47 = (((fConst42 + -0.333333343f) / fConst41) + 1.0f);
		fConst48 = (2.0f * (1.0f - (1.0f / FaustTanpuraDSP_faustpower2_f(fConst41))));
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow1 = (852.857971f * fSlow0);
		float fSlow2 = float(fHslider1);
		float fSlow3 = std::max<float>(40.0f, fSlow2);
		float fSlow4 = float(fHslider3);
		float fSlow5 = std::pow(0.00100000005f, (1.0f / (fSlow3 * std::max<float>(0.400000006f, (float(fHslider2) * (1.0f - (0.349999994f * fSlow4)))))));
		float fSlow6 = (fConst0 / fSlow3);
		int iSlow7 = int(fSlow6);
		float fSlow8 = float(iSlow7);
		float fSlow9 = (fSlow6 + (-0.499989986f - fSlow8));
		int iSlow10 = (std::min<int>(1024, std::max<int>(0, int(fSlow9))) + 1);
		float fSlow11 = (fSlow8 + std::floor(fSlow9));
		float fSlow12 = ((fSlow11 + (1.0f - fSlow6)) / (fSlow6 + (1.0f - fSlow11)));
		float fSlow13 = ((20.0f * fSlow4) + 1.0f);
		float fSlow14 = (1.0f / fSlow13);
		float fSlow15 = ((2.0f * fSlow4) + 1.0f);
		float fSlow16 = (1.0f / fSlow15);
		float fSlow17 = float(fButton0);
		float fSlow18 = (fConst8 * (((fSlow17 * float(fHslider4)) * float(fHslider5)) * float(fHslider6)));
		float fSlow19 = (1.0f / std::max<float>(1.0f, (fConst0 * float(fHslider7))));
		int iSlow20 = std::min<int>(16384, std::max<int>(0, iSlow7));
		float fSlow21 = (1350.0f * (fSlow4 / fSlow3));
		float fSlow22 = (fConst13 * fSlow2);
		float fSlow23 = (127.928703f * fSlow0);
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			float fTemp0 = fRec2[((IOTA - iSlow10) & 2047)];
			fVec0[0] = fTemp0;
			float fTempFTZ0 = (fVec0[1] - (fSlow12 * (fRec3[1] - fTemp0)));
			fRec3[0] = ((std::fabs(fTempFTZ0) > 1.17549435e-38f) ? fTempFTZ0 : 0.0f);
			float fTemp1 = ((0.00200000009f * fRec3[0]) + (0.998000026f * fRec3[1]));
			float fThen0 = (fSlow14 * float(tanhf(float((fSlow13 * fTemp1)))));
			float fElse0 = (fSlow16 * float(tanhf(float((fSlow15 * fTemp1)))));
			fVec1[0] = fSlow17;
			...
			int iTemp2 = ((fSlow17 - fVec1[1]) > 0.0f);
			iVec2[0] = iTemp2;
			iRec6[0] = ((iTemp2 > iVec2[1]) + ((iTemp2 <= iVec2[1]) * (iRec6[1] + (iRec6[1] > 0))));
			float fTemp3 = (fSlow19 * float(iRec6[0]));
			fVec3[(IOTA & 2047)] = ((fSlow5 * ((fTemp1 > 0.0f) ? fElse0 : fThen0)) + (fSlow18 * ((fRec4[2] + (fRec4[0] + (2.0f * fRec4[1]))) * std::max<float>(0.0f, std::min<float>(fTemp3, (2.0f - fTemp3))))));
			float fTempFTZ2 = fVec3[((IOTA - iSlow20) & 2047)];
			...
			float fTempFTZ4 = (fSlow22 + (fRec9[1] - std::floor((fSlow22 + fRec9[1]))));
			fRec9[0] = ((std::fabs(fTempFTZ4) > 1.17549435e-38f) ? fTempFTZ4 : 0.0f);
			float fTemp5 = std::max<float>(1.0f, ((fSlow21 * (fRec7[0] * ftbl0FaustTanpuraDSPSIG0[int((65536.0f * fRec9[0]))])) + 4.0f));
			...
			float fTemp10 = (fSlow1 * fTemp9);
			float fTempFTZ5 = (fTemp10 - (fConst14 * ((fConst15 * fRec1[2]) + (fConst16 * fRec1[1]))));
			fRec1[0] = ((std::fabs(fTempFTZ5) > 1.17549435e-38f) ? fTempFTZ5 : 0.0f);
			float fTemp11 = (fConst5 * fRec1[2]);
			float fTemp12 = (fConst4 * fRec1[0]);
			float fTempFTZ6 = (fTemp10 - (fConst22 * ((fConst23 * fRec10[2]) + (fConst24 * fRec10[1]))));
			fRec10[0] = ((std::fabs(fTempFTZ6) > 1.17549435e-38f) ? fTempFTZ6 : 0.0f);
			float fTemp13 = (fConst21 * fRec10[2]);
			float fTemp14 = (fConst20 * fRec10[0]);
			float fTempFTZ7 = (fTemp10 - (fConst30 * ((fConst31 * fRec11[2]) + (fConst32 * fRec11[1]))));
			fRec11[0] = ((std::fabs(fTempFTZ7) > 1.17549435e-38f) ? fTempFTZ7 : 0.0f);
			float fTemp15 = (fConst29 * fRec11[2]);
			float fTemp16 = (fConst28 * fRec11[0]);
			float fTempFTZ8 = (fTemp10 - (fConst38 * ((fConst39 * fRec12[2]) + (fConst40 * fRec12[1]))));
			fRec12[0] = ((std::fabs(fTempFTZ8) > 1.17549435e-38f) ? fTempFTZ8 : 0.0f);
			float fTemp17 = (fConst37 * fRec12[2]);
			float fTemp18 = (fConst36 * fRec12[0]);
			float fTempFTZ9 = (fTemp10 - (fConst46 * ((fConst47 * fRec13[2]) + (fConst48 * fRec13[1]))));
			fRec13[0] = ((std::fabs(fTempFTZ9) > 1.17549435e-38f) ? fTempFTZ9 : 0.0f);
			float fTemp19 = (fConst45 * fRec13[2]);
			float fTemp20 = (fConst44 * fRec13[0]);
			float fTemp21 = (fSlow23 * fTemp9);
			fVec5[0] = (fTemp11 + ((fTemp13 + ((fTemp15 + ((fTemp17 + ((fTemp19 + (fTemp21 + fTemp20)) + fTemp18)) + fTemp16)) + fTemp14)) + fTemp12));
			float fTempFTZ10 = ((fTemp11 + (fTemp12 + (fTemp13 + (fTemp14 + (fTemp15 + (fTemp16 + (fTemp17 + (fTemp18 + (fTemp19 + (fTemp20 + ((0.995000005f * fRec0[1]) + fTemp21))))))))))) - fVec5[1]);
