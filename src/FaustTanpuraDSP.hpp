 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			float fTempFTZ12 = (fRec10[0] + (0.999750018f * (((fTemp38 * fTemp40) + (fRec14[1] * fTemp41)) * (1.0f - fTemp20))));
			fRec9[(IOTA & 16383)] = ((std::fabs(fTempFTZ12) > 1.17549435e-38f) ? fTempFTZ12 : 0.0f);
			float fTemp42 = float((float((iVec1[((IOTA - iConst12) & 524287)] - iVec1[((IOTA - iConst13) & 524287)])) > 0.0f));
			float fThen2 = std::max<float>(0.0f, (fRec17[1] + -1.0f));
			float fTempFTZ13 = ((fTemp42 > 0.0f) ? fTemp21 : fThen2);
			fRec17[0] = ((std::fabs(fTempFTZ13) > 1.17549435e-38f) ? fTempFTZ13 : 0.0f);
			float fTemp43 = (fSlow2 * ((fTemp3 * float((fRec17[0] > 0.0f))) * fTemp22));
			fVec8[0] = fTemp43;
			...
			float fTempFTZ18 = (fRec16[0] + (0.999750018f * (((fTemp40 * fTemp46) + (fTemp41 * fRec20[1])) * (1.0f - fTemp42))));
			...
			float fTemp50 = float((float((iVec1[((IOTA - iConst14) & 524287)] - iVec1[((IOTA - iConst15) & 524287)])) > 0.0f));
			float fThen3 = std::max<float>(0.0f, (fRec23[1] + -1.0f));
			float fElse3 = (fConst0 * ftbl0FaustTanpuraDSPSIG0[int((fTemp48 + 3.0f))]);
			float fTempFTZ19 = ((fTemp50 > 0.0f) ? fElse3 : fThen3);
			fRec23[0] = ((std::fabs(fTempFTZ19) > 1.17549435e-38f) ? fTempFTZ19 : 0.0f);
			float fTemp51 = (fSlow2 * ((float((fRec23[0] > 0.0f)) * fTemp3) * ftbl0FaustTanpuraDSPSIG0[int((fTemp48 + 4.0f))]));
			fVec11[0] = fTemp51;
			...
			float fTempFTZ24 = (fRec22[0] + (0.999750018f * (((fTemp58 * fTemp60) + (fRec26[1] * fTemp61)) * (1.0f - fTemp50))));
