 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			float fTempFTZ0 = (fTemp0 - (fConst8 * ((fConst9 * fRec12[2]) + (fConst10 * fRec12[1]))));
			fRec12[0] = ((std::fabs(fTempFTZ0) > 1.17549435e-38f) ? fTempFTZ0 : 0.0f);
			fVec0[0] = fSlow1;
			...
			float fTempFTZ1 = (fTemp0 - (fConst20 * ((fConst21 * fRec15[2]) + (fConst22 * fRec15[1]))));
			...
			float fTempFTZ2 = (fConst28 * ((0.600000024f * (fRec11[((IOTA - 8001) & 8191)] + fRec11[((IOTA - 8002) & 8191)])) - (fConst29 * fRec16[1])));
			fRec16[0] = ((std::fabs(fTempFTZ2) > 1.17549435e-38f) ? fTempFTZ2 : 0.0f);
			float fTempFTZ3 = (fTemp0 - (fConst34 * ((fConst35 * fRec17[2]) + (fConst36 * fRec17[1]))));
			fRec17[0] = ((std::fabs(fTempFTZ3) > 1.17549435e-38f) ? fTempFTZ3 : 0.0f);
			...
			float fTempFTZ4 = (fTemp2 + ((0.5f * fTemp3) + (fRec16[0] + fTemp4)));
			fRec11[(IOTA & 8191)] = ((std::fabs(fTempFTZ4) > 1.17549435e-38f) ? fTempFTZ4 : 0.0f);
			...
			float fTempFTZ5 = ((fRec10[1] * (fTemp11 - fTemp12)) + ((fTemp7 * fRec7[1]) * (fTemp12 + (1.0f - fTemp11))));
			...
			float fTempFTZ6 = fVec3[((IOTA - int(std::min<float>(float(int(std::pow(2.0f, std::max<float>(1.0f, std::ceil((1.44269502f * std::log(fTemp13))))))), fConst44))) & 4095)];
			fRec8[0] = ((std::fabs(fTempFTZ6) > 1.17549435e-38f) ? fTempFTZ6 : 0.0f);
			float fTempFTZ7 = (0.0f - (0.600000024f * fTemp15));
			...
			float fTempFTZ8 = ((fRec20[1] * (fTemp20 - fTemp21)) + ((fTemp16 * fRec3[1]) * (fTemp21 + (1.0f - fTemp20))));
			fRec20[0] = ((std::fabs(fTempFTZ8) > 1.17549435e-38f) ? fTempFTZ8 : 0.0f);
			...
			float fTempFTZ9 = fVec5[((IOTA - int(std::min<float>(float(int(std::pow(2.0f, std::max<float>(1.0f, std::ceil((1.44269502f * std::log(fTemp22))))))), fConst49))) & 8191)];
			fRec18[0] = ((std::fabs(fTempFTZ9) > 1.17549435e-38f) ? fTempFTZ9 : 0.0f);
			float fTempFTZ10 = (0.0f - (0.600000024f * fTemp23));
			float fRec19 = ((std::fabs(fTempFTZ10) > 1.17549435e-38f) ? fTempFTZ10 : 0.0f);
			...
			float fTempFTZ11 = ((fRec23[1] * (fTemp28 - fTemp29)) + ((fTemp24 * fRec5[1]) * (fTemp29 + (1.0f - fTemp28))));
			fRec23[0] = ((std::fabs(fTempFTZ11) > 1.17549435e-38f) ? fTempFTZ11 : 0.0f);
			...
			float fTempFTZ12 = fVec7[((IOTA - int(std::min<float>(float(int(std::pow(2.0f, std::max<float>(1.0f, std::ceil((1.44269502f * std::log(fTemp30))))))), fConst54))) & 8191)];
			fRec21[0] = ((std::fabs(fTempFTZ12) > 1.17549435e-38f) ? fTempFTZ12 : 0.0f);
			float fTempFTZ13 = (0.0f - (0.600000024f * fTemp31));
			float fRec22 = ((std::fabs(fTempFTZ13) > 1.17549435e-38f) ? fTempFTZ13 : 0.0f);
			...
			float fTempFTZ14 = ((fRec26[1] * (fTemp36 - fTemp37)) + ((fTemp32 * fRec1[1]) * (fTemp37 + (1.0f - fTemp36))));
			fRec26[0] = ((std::fabs(fTempFTZ14) > 1.17549435e-38f) ? fTempFTZ14 : 0.0f);
			...
			float fTempFTZ15 = fVec9[((IOTA - int(std::min<float>(float(int(std::pow(2.0f, std::max<float>(1.0f, std::ceil((1.44269502f * std::log(fTemp38))))))), fConst59))) & 8191)];
			fRec24[0] = ((std::fabs(fTempFTZ15) > 1.17549435e-38f) ? fTempFTZ15 : 0.0f);
			float fTempFTZ16 = (0.0f - (0.600000024f * fTemp39));
			float fRec25 = ((std::fabs(fTempFTZ16) > 1.17549435e-38f) ? fTempFTZ16 : 0.0f);
			...
			float fTempFTZ17 = ((fRec29[1] * (fTemp44 - fTemp45)) + ((fTemp40 * fRec6[1]) * (fTemp45 + (1.0f - fTemp44))));
			fRec29[0] = ((std::fabs(fTempFTZ17) > 1.17549435e-38f) ? fTempFTZ17 : 0.0f);
			...
			float fTempFTZ18 = fVec11[((IOTA - int(std::min<float>(float(int(std::pow(2.0f, std::max<float>(1.0f, std::ceil((1.44269502f * std::log(fTemp46))))))), fConst64))) & 4095)];
			fRec27[0] = ((std::fabs(fTempFTZ18) > 1.17549435e-38f) ? fTempFTZ18 : 0.0f);
			float fTempFTZ19 = (0.600000024f * fTemp47);
			float fRec28 = ((std::fabs(fTempFTZ19) > 1.17549435e-38f) ? fTempFTZ19 : 0.0f);
			...
			float fTempFTZ20 = ((fRec32[1] * (fTemp52 - fTemp53)) + ((fTemp48 * fRec2[1]) * (fTemp53 + (1.0f - fTemp52))));
			fRec32[0] = ((std::fabs(fTempFTZ20) > 1.17549435e-38f) ? fTempFTZ20 : 0.0f);
			...
			float fTempFTZ21 = fVec13[((IOTA - int(std::min<float>(float(int(std::pow(2.0f, std::max<float>(1.0f, std::ceil((1.44269502f * std::log(fTemp54))))))), fConst69))) & 8191)];
			fRec30[0] = ((std::fabs(fTempFTZ21) > 1.17549435e-38f) ? fTempFTZ21 : 0.0f);
			float fTempFTZ22 = (0.600000024f * fTemp55);
			float fRec31 = ((std::fabs(fTempFTZ22) > 1.17549435e-38f) ? fTempFTZ22 : 0.0f);
			...
			float fTempFTZ23 = ((fRec35[1] * (fTemp60 - fTemp61)) + ((fTemp56 * fRec4[1]) * (fTemp61 + (1.0f - fTemp60))));
			fRec35[0] = ((std::fabs(fTempFTZ23) > 1.17549435e-38f) ? fTempFTZ23 : 0.0f);
			...
			float fTempFTZ24 = fVec15[((IOTA - int(std::min<float>(float(int(std::pow(2.0f, std::max<float>(1.0f, std::ceil((1.44269502f * std::log(fTemp62))))))), fConst74))) & 8191)];
			fRec33[0] = ((std::fabs(fTempFTZ24) > 1.17549435e-38f) ? fTempFTZ24 : 0.0f);
			float fTempFTZ25 = (0.600000024f * fTemp63);
			float fRec34 = ((std::fabs(fTempFTZ25) > 1.17549435e-38f) ? fTempFTZ25 : 0.0f);
			...
			float fTempFTZ26 = ((fRec38[1] * (fTemp68 - fTemp69)) + ((fTemp64 * fRec0[1]) * (fTemp69 + (1.0f - fTemp68))));
			fRec38[0] = ((std::fabs(fTempFTZ26) > 1.17549435e-38f) ? fTempFTZ26 : 0.0f);
			...
			float fTempFTZ27 = fVec17[((IOTA - int(std::min<float>(float(int(std::pow(2.0f, std::max<float>(1.0f, std::ceil((1.44269502f * std::log(fTemp70))))))), fConst79))) & 4095)];
			fRec36[0] = ((std::fabs(fTempFTZ27) > 1.17549435e-38f) ? fTempFTZ27 : 0.0f);
			float fTempFTZ28 = (0.600000024f * fTemp71);
			float fRec37 = ((std::fabs(fTempFTZ28) > 1.17549435e-38f) ? fTempFTZ28 : 0.0f);
			float fTemp72 = (fRec37 + fRec34);
			float fTemp73 = (fRec28 + (fRec31 + fTemp72));
			float fTempFTZ29 = (fRec8[1] + (fRec18[1] + (fRec21[1] + (fRec24[1] + (fRec27[1] + (fRec30[1] + (fRec33[1] + (fRec36[1] + (fRec9 + (fRec19 + (fRec22 + (fRec25 + fTemp73))))))))))));
			fRec0[0] = ((std::fabs(fTempFTZ29) > 1.17549435e-38f) ? fTempFTZ29 : 0.0f);
			float fTempFTZ30 = ((fRec27[1] + (fRec30[1] + (fRec33[1] + (fRec36[1] + fTemp73)))) - (fRec8[1] + (fRec18[1] + (fRec21[1] + (fRec24[1] + (fRec9 + (fRec19 + (fRec25 + fRec22))))))));
			fRec1[0] = ((std::fabs(fTempFTZ30) > 1.17549435e-38f) ? fTempFTZ30 : 0.0f);
			float fTemp74 = (fRec31 + fRec28);
			float fTempFTZ31 = ((fRec21[1] + (fRec24[1] + (fRec33[1] + (fRec36[1] + (fRec22 + (fRec25 + fTemp72)))))) - (fRec8[1] + (fRec18[1] + (fRec27[1] + (fRec30[1] + (fRec9 + (fRec19 + fTemp74)))))));
			fRec2[0] = ((std::fabs(fTempFTZ31) > 1.17549435e-38f) ? fTempFTZ31 : 0.0f);
			float fTempFTZ32 = ((fRec8[1] + (fRec18[1] + (fRec33[1] + (fRec36[1] + (fRec9 + (fRec19 + fTemp72)))))) - (fRec21[1] + (fRec24[1] + (fRec27[1] + (fRec30[1] + (fRec22 + (fRec25 + fTemp74)))))));
			fRec3[0] = ((std::fabs(fTempFTZ32) > 1.17549435e-38f) ? fTempFTZ32 : 0.0f);
			float fTemp75 = (fRec37 + fRec31);
			float fTemp76 = (fRec34 + fRec28);
			float fTempFTZ33 = ((fRec18[1] + (fRec24[1] + (fRec30[1] + (fRec36[1] + (fRec19 + (fRec25 + fTemp75)))))) - (fRec8[1] + (fRec21[1] + (fRec27[1] + (fRec33[1] + (fRec9 + (fRec22 + fTemp76)))))));
			fRec4[0] = ((std::fabs(fTempFTZ33) > 1.17549435e-38f) ? fTempFTZ33 : 0.0f);
			float fTempFTZ34 = ((fRec8[1] + (fRec21[1] + (fRec30[1] + (fRec36[1] + (fRec9 + (fRec22 + fTemp75)))))) - (fRec18[1] + (fRec24[1] + (fRec27[1] + (fRec33[1] + (fRec19 + (fRec25 + fTemp76)))))));
			fRec5[0] = ((std::fabs(fTempFTZ34) > 1.17549435e-38f) ? fTempFTZ34 : 0.0f);
			float fTemp77 = (fRec37 + fRec28);
			float fTemp78 = (fRec34 + fRec31);
			float fTempFTZ35 = ((fRec8[1] + (fRec24[1] + (fRec27[1] + (fRec36[1] + (fRec9 + (fRec25 + fTemp77)))))) - (fRec18[1] + (fRec21[1] + (fRec30[1] + (fRec33[1] + (fRec19 + (fRec22 + fTemp78)))))));
			fRec6[0] = ((std::fabs(fTempFTZ35) > 1.17549435e-38f) ? fTempFTZ35 : 0.0f);
			float fTempFTZ36 = ((fRec18[1] + (fRec21[1] + (fRec27[1] + (fRec36[1] + (fRec19 + (fRec22 + fTemp77)))))) - (fRec8[1] + (fRec24[1] + (fRec30[1] + (fRec33[1] + (fRec9 + (fRec25 + fTemp78)))))));
			fRec7[0] = ((std::fabs(fTempFTZ36) > 1.17549435e-38f) ? fTempFTZ36 : 0.0f);
