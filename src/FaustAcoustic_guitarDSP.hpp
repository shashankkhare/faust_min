...
class FaustAcoustic_guitarDSP : public dsp {
 ...
 public:
	...
	virtual void instanceResetUserInterface() {
		...
		fHslider4 = FAUSTFLOAT(0.67000000000000004f);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("pluckPosition", &fHslider4, FAUSTFLOAT(0.670000017f), FAUSTFLOAT(0.00999999978f), FAUSTFLOAT(0.99000001f), FAUSTFLOAT(0.00999999978f));
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		int iSlow8 = (iSlow7 == 0);
		int iSlow9 = (iSlow7 == 1);
		float fSlow10 = (fSlow1 * std::pow(2.0f, (0.000833333354f * float(fHslider3))));
		float fSlow11 = (340.0f / fSlow10);
		float fSlow12 = (fConst6 * (fSlow11 + -0.100000001f));
		float fSlow13 = (fConst7 * float(fHslider4));
		float fSlow14 = std::tan((fConst9 * fSlow10));
		float fSlow15 = (1.0f / fSlow14);
		float fSlow16 = (((fSlow15 + 1.41421354f) / fSlow14) + 1.0f);
		float fSlow17 = (0.100000001f * (float(fHslider5) / fSlow16));
		float fSlow18 = (1.0f / fSlow16);
		float fSlow19 = (((fSlow15 + -1.41421354f) / fSlow14) + 1.0f);
		float fSlow20 = (2.0f * (1.0f - (1.0f / FaustAcoustic_guitarDSP_faustpower2_f(fSlow14))));
		float fSlow21 = (1.0f / std::max<float>(1.0f, (fConst10 * FaustAcoustic_guitarDSP_faustpower2_f((1.0f - (0.00033333333f * fSlow10))))));
		float fSlow22 = float(fButton0);
		float fSlow23 = (fConst6 * (fSlow11 + -0.109999999f));
		float fSlow24 = (1.0f / fSlow4);
		float fSlow25 = (((fSlow3 + -0.125f) / fSlow2) + 1.0f);
		float fSlow26 = (2.0f * (1.0f - (1.0f / FaustAcoustic_guitarDSP_faustpower2_f(fSlow2))));
		float fSlow27 = std::tan((fConst36 * fSlow1));
		float fSlow28 = (1.0f / fSlow27);
		float fSlow29 = (((fSlow28 + 0.100000001f) / fSlow27) + 1.0f);
		float fSlow30 = (0.800000012f / (fSlow27 * fSlow29));
		float fSlow31 = (0.0f - fSlow30);
		float fSlow32 = (1.0f / fSlow29);
		float fSlow33 = (((fSlow28 + -0.100000001f) / fSlow27) + 1.0f);
		float fSlow34 = (2.0f * (1.0f - (1.0f / FaustAcoustic_guitarDSP_faustpower2_f(fSlow27))));
		float fSlow35 = std::tan((fConst37 * fSlow1));
		float fSlow36 = (1.0f / fSlow35);
		float fSlow37 = (((fSlow36 + 0.0833333358f) / fSlow35) + 1.0f);
		float fSlow38 = (1.0f / (fSlow35 * fSlow37));
		float fSlow39 = (1.0f / fSlow37);
		float fSlow40 = (((fSlow36 + -0.0833333358f) / fSlow35) + 1.0f);
		float fSlow41 = (2.0f * (1.0f - (1.0f / FaustAcoustic_guitarDSP_faustpower2_f(fSlow35))));
		float fSlow42 = (0.0f - fSlow38);
		float fSlow43 = std::tan((fConst38 * fSlow1));
		float fSlow44 = (1.0f / fSlow43);
		float fThen3 = (iSlow9 ? 10.0f : 20.0f);
		float fSlow45 = (1.0f / (iSlow8 ? 8.0f : fThen3));
		float fSlow46 = ((fSlow44 * (fSlow44 - fSlow45)) + 1.0f);
		float fSlow47 = (2.0f * (1.0f - (1.0f / FaustAcoustic_guitarDSP_faustpower2_f(fSlow43))));
		float fSlow48 = ((fSlow44 * (fSlow44 + fSlow45)) + 1.0f);
		float fThen5 = (iSlow9 ? 2.0f : 1.5f);
		float fSlow49 = (iSlow8 ? 0.600000024f : fThen5);
		float fSlow50 = (0.0f - (fSlow44 * (fSlow49 / fSlow48)));
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			float fTemp27 = (fSlow12 * fRec28[0]);
			...
			float fTempFTZ7 = (fTemp53 - (fSlow18 * ((fSlow19 * fRec33[2]) + (fSlow20 * fRec33[1]))));
			...
			fVec1[0] = fSlow22;
			iRec38[0] = ((fSlow22 > fVec1[1]) + ((fSlow22 <= fVec1[1]) * (iRec38[1] + (iRec38[1] > 0))));
			...
			float fTemp58 = (fSlow21 * float(iRec35[0]));
			float fTemp59 = (fSlow17 * ((fRec33[2] + (fRec33[0] + (2.0f * fRec33[1]))) * std::max<float>(0.0f, std::min<float>(fTemp58, (2.0f - fTemp58)))));
			...
			float fTemp87 = (fSlow23 * fRec28[0]);
			...
			float fTempFTZ58 = (fTemp114 - (fSlow24 * ((fSlow25 * fRec1[2]) + (fSlow26 * fRec1[1]))));
			fRec1[0] = ((std::fabs(fTempFTZ58) > 1.17549435e-38f) ? fTempFTZ58 : 0.0f);
			float fTempFTZ59 = (fTemp114 - (fSlow32 * ((fSlow33 * fRec71[2]) + (fSlow34 * fRec71[1]))));
			fRec71[0] = ((std::fabs(fTempFTZ59) > 1.17549435e-38f) ? fTempFTZ59 : 0.0f);
			float fTempFTZ60 = (fTemp114 - (fSlow39 * ((fSlow40 * fRec72[2]) + (fSlow41 * fRec72[1]))));
			fRec72[0] = ((std::fabs(fTempFTZ60) > 1.17549435e-38f) ? fTempFTZ60 : 0.0f);
			float fTemp115 = (0.333333343f * ((fSlow6 * fRec1[2]) + (((fSlow31 * fRec71[2]) + (((fSlow38 * fRec72[0]) + (fSlow42 * fRec72[2])) + (fSlow30 * fRec71[0]))) + (fSlow5 * fRec1[0]))));
			float fTempFTZ61 = (fTemp114 - (((fRec73[2] * fSlow46) + (fSlow47 * fRec73[1])) / fSlow48));
			fRec73[0] = ((std::fabs(fTempFTZ61) > 1.17549435e-38f) ? fTempFTZ61 : 0.0f);
			float fTemp116 = (fRec73[2] * fSlow50);
			float fTemp117 = (fSlow44 * ((fSlow49 * fRec73[0]) / fSlow48));
