...
class FaustBowlDSP : public dsp {
 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow2 = (5.5f * ((1.0f - fSlow0) * fSlow1));
		...
		float fSlow55 = (5.5f * (fSlow0 * fSlow1));
		...
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			float fTempFTZ3 = ((0.991999984f * fVec1[((IOTA - iSlow17) & 8191)]) - ((fSlow18 * fRec14[1]) + (fConst3 * fRec14[2])));
			...
			float fTempFTZ6 = ((0.991999984f * fVec2[((IOTA - iSlow20) & 8191)]) - ((fSlow21 * fRec20[1]) + (fConst3 * fRec20[2])));
			...
			float fTempFTZ9 = ((0.991999984f * fVec3[((IOTA - iSlow22) & 8191)]) - ((fSlow23 * fRec22[1]) + (fConst3 * fRec22[2])));
			...
			float fTempFTZ12 = ((0.991999984f * fVec4[((IOTA - iSlow25) & 8191)]) - ((fSlow26 * fRec24[1]) + (fConst3 * fRec24[2])));
			...
			float fTempFTZ15 = ((0.991999984f * fVec5[((IOTA - iSlow27) & 4095)]) - ((fSlow28 * fRec26[1]) + (fConst3 * fRec26[2])));
			...
			float fTempFTZ18 = ((0.991999984f * fVec6[((IOTA - iSlow29) & 4095)]) - ((fSlow30 * fRec28[1]) + (fConst3 * fRec28[2])));
			...
			float fTempFTZ21 = ((0.991999984f * fVec7[((IOTA - iSlow32) & 2047)]) - ((fSlow33 * fRec30[1]) + (fConst3 * fRec30[2])));
			...
			float fTempFTZ24 = ((0.991999984f * fVec8[((IOTA - iSlow34) & 2047)]) - ((fSlow35 * fRec32[1]) + (fConst3 * fRec32[2])));
			...
			float fTempFTZ27 = ((0.991999984f * fVec9[((IOTA - iSlow37) & 1023)]) - ((fSlow38 * fRec34[1]) + (fConst3 * fRec34[2])));
			...
			float fTempFTZ30 = ((0.991999984f * fVec10[((IOTA - iSlow39) & 1023)]) - ((fSlow40 * fRec36[1]) + (fConst3 * fRec36[2])));
			...
			float fTempFTZ33 = ((0.991999984f * fVec11[((IOTA - iSlow41) & 8191)]) - ((fSlow42 * fRec38[1]) + (fConst3 * fRec38[2])));
			...
			float fTempFTZ36 = ((0.991999984f * fVec12[((IOTA - iSlow43) & 4095)]) - ((fSlow44 * fRec40[1]) + (fConst3 * fRec40[2])));
			...
			float fTempFTZ39 = ((0.991999984f * fVec13[((IOTA - iSlow45) & 2047)]) - ((fSlow46 * fRec42[1]) + (fConst3 * fRec42[2])));
