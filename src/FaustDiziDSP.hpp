...
#ifndef  __FaustDiziDSP_H__
#define  __FaustDiziDSP_H__
...
class FaustDiziDSPSIG0 {
  ...
  public:
	...
	int getNumInputsFaustDiziDSPSIG0() {
		return 0;
	}
	int getNumOutputsFaustDiziDSPSIG0() {
		return 1;
	}
	
	void instanceInitFaustDiziDSPSIG0(int sample_rate) {
	...
	void fillFaustDiziDSPSIG0(int count, float* table) {
...
static FaustDiziDSPSIG0* newFaustDiziDSPSIG0() { return (FaustDiziDSPSIG0*)new FaustDiziDSPSIG0(); }
static void deleteFaustDiziDSPSIG0(FaustDiziDSPSIG0* dsp) { delete dsp; }

static float ftbl0FaustDiziDSPSIG0[65536];
static float FaustDiziDSP_faustpower2_f(float value) {
	return (value * value);
}

#ifndef FAUSTCLASS 
#define FAUSTCLASS FaustDiziDSP
#endif
...
class FaustDiziDSP : public dsp {
 ...
 public:
	...
	static void classInit(int sample_rate) {
		FaustDiziDSPSIG0* sig0 = newFaustDiziDSPSIG0();
		sig0->instanceInitFaustDiziDSPSIG0(sample_rate);
		sig0->fillFaustDiziDSPSIG0(65536, ftbl0FaustDiziDSPSIG0);
		deleteFaustDiziDSPSIG0(sig0);
	}
	...
	virtual FaustDiziDSP* clone() {
		return new FaustDiziDSP();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			float fTempFTZ32 = (fSlow14 + (fConst2 * fRec36[1]));
			fRec36[0] = ((std::fabs(fTempFTZ32) > 1.17549435e-38f) ? fTempFTZ32 : 0.0f);
			float fTempFTZ33 = ((fRec1[0] + (0.995000005f * fRec38[1])) - fRec1[1]);
			fRec38[0] = ((std::fabs(fTempFTZ33) > 1.17549435e-38f) ? fTempFTZ33 : 0.0f);
			float fTempFTZ34 = (fSlow15 + (fConst2 * fRec39[1]));
			fRec39[0] = ((std::fabs(fTempFTZ34) > 1.17549435e-38f) ? fTempFTZ34 : 0.0f);
			float fTemp58 = std::tan((fConst8 * fRec39[0]));
			float fTemp59 = (1.0f / fTemp58);
			float fTemp60 = (((fTemp59 + 0.25f) / fTemp58) + 1.0f);
			float fTempFTZ35 = ((fRec38[0] * ((((1.5f * fRec36[0]) + 1.0f) + (2.0f * (fRec36[0] * std::fabs(fRec38[0])))) + (3.0f * (fRec36[0] * FaustDiziDSP_faustpower2_f(fRec38[0]))))) - (((fRec37[2] * (((fTemp59 + -0.25f) / fTemp58) + 1.0f)) + (2.0f * (fRec37[1] * (1.0f - (1.0f / FaustDiziDSP_faustpower2_f(fTemp58)))))) / fTemp60));
			fRec37[0] = ((std::fabs(fTempFTZ35) > 1.17549435e-38f) ? fTempFTZ35 : 0.0f);
