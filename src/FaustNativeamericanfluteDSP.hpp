...
class FaustNativeamericanfluteDSP : public dsp {
 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow8 = (fConst2 * float(fHslider3));
		float fSlow9 = float(fHslider4);
		int iSlow10 = (std::fabs(fSlow9) < 1.1920929e-07f);
		float fThen3 = std::exp((0.0f - (fConst1 / (iSlow10 ? 1.0f : fSlow9))));
		...
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			float fTempFTZ5 = (fSlow7 + (fConst3 * fRec26[1]));
			fRec26[0] = ((std::fabs(fTempFTZ5) > 1.17549435e-38f) ? fTempFTZ5 : 0.0f);
			float fTempFTZ6 = ((fRec25[1] * fSlow2) + (std::min<float>(1.0f, (fSlow3 * fRec26[0])) * fSlow4));
			fRec25[0] = ((std::fabs(fTempFTZ6) > 1.17549435e-38f) ? fTempFTZ6 : 0.0f);
			float fTempFTZ7 = (fSlow8 + (fConst3 * fRec27[1]));
			fRec27[0] = ((std::fabs(fTempFTZ7) > 1.17549435e-38f) ? fTempFTZ7 : 0.0f);
			float fTempFTZ8 = ((fConst4 * fRec28[1]) + (0.5f * float(((fSlow3 - fVec0[1]) > 0.0f))));
			...
			float fTempFTZ13 = (fSlow13 + (fConst3 * fRec34[1]));
			fRec34[0] = ((std::fabs(fTempFTZ13) > 1.17549435e-38f) ? fTempFTZ13 : 0.0f);
			float fTempFTZ14 = (fConst7 + (fRec36[1] - std::floor((fConst7 + fRec36[1]))));
			...
			float fTempFTZ15 = (fSlow14 + (fConst3 * fRec37[1]));
			fRec37[0] = ((std::fabs(fTempFTZ15) > 1.17549435e-38f) ? fTempFTZ15 : 0.0f);
			float fTemp2 = (0.25f * fRec37[0]);
			float fTemp3 = (fConst6 * (fTemp1 * (fTemp2 + 0.150000006f)));
			...
			float fTemp31 = (fConst6 * (fTemp1 * (0.850000024f - fTemp2)));
