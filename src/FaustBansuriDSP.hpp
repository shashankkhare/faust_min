...
class FaustBansuriDSP : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		float fConst6 = (((fConst5 + 1.41421354f) / fConst4) + 1.0f);
		fConst7 = (0.0599999987f / fConst6);
		fConst8 = (1.0f / fConst6);
		fConst9 = (((fConst5 + -1.41421354f) / fConst4) + 1.0f);
		fConst10 = (2.0f * (1.0f - (1.0f / FaustBansuriDSP_faustpower2_f(fConst4))));
		fConst11 = (0.00882352982f * fConst0);
		fConst12 = (0.00147058826f * fConst0);
		fConst13 = (5.5f / fConst0);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow14 = (fConst15 * fSlow4);
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			iRec15[0] = 0;
			fRec22[0] = ((0.300000012f * fRec22[1]) + (0.67900002f * fRec20[1]));
			fRec21[0] = ((0.400000006f * fRec21[1]) + (0.600000024f * fRec22[0]));
			float fRec19 = (fRec21[0] + float(iRec15[1]));
			fRec24[0] = (fSlow5 + (fConst3 * fRec24[1]));
			fRec23[0] = ((fRec23[1] * fSlow3) + (std::min<float>(1.0f, (fSlow4 * fRec24[0])) * fSlow6));
			fRec25[0] = (fSlow7 + (fConst3 * fRec25[1]));
			iRec27[0] = ((1103515245 * iRec27[1]) + 12345);
			fRec26[0] = ((4.65661287e-10f * float(iRec27[0])) - (fConst8 * ((fConst9 * fRec26[2]) + (fConst10 * fRec26[1]))));
			fRec28[0] = fRec1[1];
			fRec29[(IOTA & 2047)] = (0.980000019f * fRec28[1]);
			fRec30[0] = ((fRec30[1] * fSlow10) + fSlow11);
			fRec31[0] = (fSlow12 + (fConst3 * fRec31[1]));
			fRec33[0] = (fConst13 + (fRec33[1] - std::floor((fConst13 + fRec33[1]))));
			float fTemp0 = ((340.0f / (fRec30[0] * ((0.0199999996f * (fRec31[0] * ftbl0FaustBansuriDSPSIG0[int((65536.0f * fRec33[0]))])) + 1.0f))) + 0.270000011f);
			fRec34[0] = (fSlow13 + (fConst3 * fRec34[1]));
			float fTemp1 = (0.400000006f * (fRec34[0] + -0.5f));
			float fTemp2 = (fConst12 * (fTemp0 * (fTemp1 + 0.270000011f)));
			float fTemp3 = (fTemp2 + -1.49999499f);
			int iTemp4 = int(fTemp3);
			int iTemp5 = (int(std::min<float>(fConst11, float(std::max<int>(0, iTemp4)))) + 1);
			...
			int iTemp16 = (int(std::min<float>(fConst11, float(std::max<int>(0, (iTemp4 + 1))))) + 1);
			float fTemp17 = (0.0f - fTemp9);
			float fTemp18 = (0.0f - (0.5f * fTemp11));
			float fTemp19 = (0.0f - (0.333333343f * fTemp13));
			int iTemp20 = (int(std::min<float>(fConst11, float(std::max<int>(0, (iTemp4 + 2))))) + 1);
			float fTemp21 = (0.0f - fTemp11);
			float fTemp22 = (0.0f - (0.5f * fTemp13));
			float fTemp23 = (fTemp7 * fTemp9);
			int iTemp24 = (int(std::min<float>(fConst11, float(std::max<int>(0, (iTemp4 + 3))))) + 1);
			float fTemp25 = (0.0f - fTemp13);
			float fTemp26 = (fTemp23 * fTemp11);
			int iTemp27 = (int(std::min<float>(fConst11, float(std::max<int>(0, (iTemp4 + 4))))) + 1);
			...
			float fTemp28 = ((fRec23[0] * ((fConst7 * (fRec25[0] * (fRec26[2] + (fRec26[0] + (2.0f * fRec26[1]))))) + 1.0f)) - (0.5f * fVec1[1]));
			...
			float fTemp30 = (fConst12 * (fTemp0 * (0.730000019f - fTemp1)));
			float fTemp31 = (fTemp30 + -1.49999499f);
			int iTemp32 = int(fTemp31);
			int iTemp33 = (int(std::min<float>(fConst11, float(std::max<int>(0, iTemp32)))) + 1);
			...
			int iTemp44 = (int(std::min<float>(fConst11, float(std::max<int>(0, (iTemp32 + 1))))) + 1);
			float fTemp45 = (0.0f - fTemp37);
			float fTemp46 = (0.0f - (0.5f * fTemp39));
			float fTemp47 = (0.0f - (0.333333343f * fTemp41));
			int iTemp48 = (int(std::min<float>(fConst11, float(std::max<int>(0, (iTemp32 + 2))))) + 1);
			float fTemp49 = (0.0f - fTemp39);
			float fTemp50 = (0.0f - (0.5f * fTemp41));
			float fTemp51 = (fTemp35 * fTemp37);
			int iTemp52 = (int(std::min<float>(fConst11, float(std::max<int>(0, (iTemp32 + 3))))) + 1);
			float fTemp53 = (0.0f - fTemp41);
			float fTemp54 = (fTemp51 * fTemp39);
			int iTemp55 = (int(std::min<float>(fConst11, float(std::max<int>(0, (iTemp32 + 4))))) + 1);
			...
			fRec35[0] = (fSlow14 + (fConst14 * fRec35[1]));
