...
// Modeled after an extremely thin, high-tension skin that oscillates faster (freq_right=880Hz) and bounces/resonates more
tilli_mode1 = resonator(freq_right * 1.00, 0.26 * tilliDecay, tilli_m1_g, excitationTilli);
tilli_mode2 = resonator(freq_right * 1.59, 0.15 * tilliDecay, tilli_m2_g, excitationTilli);
tilli_mode3 = resonator(freq_right * 2.14, 0.09 * tilliDecay, tilli_m3_g, excitationTilli);
tilli_mode4 = resonator(freq_right * 2.65, 0.04 * tilliDecay, tilli_m4_g, excitationTilli);
