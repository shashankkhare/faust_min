...
tableData = waveform {
    ...
    // LowSa (65.41 Hz)
    65.41,0.050,0.12,0.0115,0.20,1800,0.10,0.35,

    // Sa (130.81 Hz)
    130.81,0.035,0.10,0.0060,0.35,2600,0.07,0.80,

    // Pa (196.00 Hz)
    196.00,0.025,0.09,0.0040,0.50,3600,0.045,1.00,

    // HighSa (261.63 Hz)
    261.63,0.018,0.08,0.0030,0.65,4500,0.035,0.60
};
