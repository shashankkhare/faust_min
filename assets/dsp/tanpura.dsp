...
tableData = waveform {
    ...
    // LowSa (65.41 Hz)
    65.41,0.015,0.55,0.0150,0.50,1500,0.10,1.20,

    // Sa (130.81 Hz)
    130.81,0.020,0.45,0.0115,0.40,2000,0.07,1.00,

    // Pa (196.00 Hz)
    196.00,0.025,0.35,0.0085,0.45,2400,0.05,0.90,

    // HighSa (261.63 Hz)
    261.63,0.030,0.25,0.0060,0.50,2800,0.03,0.80
};
