...
## 🚀 Roadmap
- **Enhanced Playing Techniques:** Support enhanced playing techniques for all instruments.
- **Enhanced Mixer:** Support chaining (parallel/serial) various DSP elements like echo, bandpass, etc.
